      ...
      <div class="col-md-12"> 
        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase" id="title_span"> Optom Work Up Report </span></div>
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-3">
                      <div class="form-group">
                        <label class="control-label">Optom</label>
                        <select class=" form-control select2" name="optom_id" id="optom_id"  >
                          <option value="0">All Optom</option>
                          <?php 
								  $sql7="SELECT `users`.`id`,`user_infos`.`name` FROM `users` INNER JOIN `user_infos` ON `users`.`id` =`user_infos`.`users_id` WHERE  `users`.`role`='4' AND `users`.`del_flag`='0' ORDER BY `user_infos`.`name` ASC ";
...
function date_wise_db(){
	...
	var optom_id=$("#optom_id").val();
	var print_url="<?php echo ADMIN_URL.'optom_work_up_report_fecth.php?from_date=';  ?>"+from_date+"<?php echo '&to_date=';  ?>"+to_date+"<?php echo '&optom_id=';  ?>"+optom_id;

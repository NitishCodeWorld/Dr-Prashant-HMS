...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$lens_masters_name=mysqli_real_escape_string($conn,$_REQUEST['lens_masters_name']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `lens_masters_for_emr` SET `lens_masters_name`='".$lens_masters_name."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'lens_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `lens_masters_for_emr`(`lens_masters_name`) VALUES ('".$lens_masters_name."')";
...

{
	...
	$sql = "DELETE FROM `lens_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
	...
	header("location:".ADMIN_URL."lens_masters_for_emr.php?msg=".$msg."&flg=".$flg);
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `lens_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Lens Master Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `lens_masters_name` FROM `lens_masters_for_emr` ORDER BY `id` DESC";
...

				 {
                  ...
                  <tr >
                    ...
                    <td><?php echo $row3['lens_masters_name']; ?></td>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-title" >
                          ...
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Lens Master</div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label">Lens Master Name</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <textarea name="lens_masters_name" id="lens_masters_name" class="form-control" placeholder="Enter text" required></textarea>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/lens_master_ajax_for_emr.php",
						...
						success : function(data) {						
							...
							try{
								 ...
								 $("#lens_masters_name").val(data.lens_masters_name);

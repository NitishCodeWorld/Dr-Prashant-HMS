              ...
              <form action="" method="post" enctype="multipart/form-data" class="horizontal-form">
                          ...
                          <div class="portlet-body">
                            <div class="row">
                              <div class="col-md-12"><br>
                                <div class="col-md-6">
                                  <p><span id="span_title"><u>Prescribing medicine to the patient</u></span></p>
                                </div>
                                <div class="col-md-3">
                                  <div class="checkbox-list" style="padding-top:6px !important">
                                    <label class="checkbox-inline">
                                ...
                                <div class="table-scrollable">
                                  <table class="table table-striped table-bordered table-advance table-hover">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td colspan="4" ><textarea id="general_instructions" name="general_instructions" class="form-control" rows="3" placeholder="Enter general Instructions"><?php echo $row['general_instructions']; ?></textarea></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
                      ...
                      <div class="col-md-12" style="margin-bottom:4px; padding-top:0;">
                        <div class="table-scrollable">
                          <table class="table table-striped table-bordered table-advance table-hover" width="50%">
                            <tbody>
                              <tr>
                                <td ><textarea id="remarks_pres" name="remarks_pres" class="form-control" rows="4" placeholder="Enter Remarks"><?php echo $row['remarks_pres']; ?></textarea></td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
                ...
                <div class="col-md-12" style="background:#3e9999; padding:9px 0px">
                  ...
                  <div class="col-md-12" style="margin-bottom:4px;overflow-x: auto !important;">
                    <div class="table-scrollable">
                      <table class="table table-striped table-bordered table-advance table-hover" id="patient_related_iop_tab" style="overflow-x: auto !important;">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <tr id="patient_related_iop<?php echo $sl; ?>">
                            <td style="min-width:200px !important"><input type="text" class="form-control" name="patient_related_document_name<?php echo $sl; ?>" id="patient_related_document_name<?php echo $sl; ?>" value="<?php echo $row5['patient_related_document_name']; ?>" >
                            ...
                            <td style="min-width:100px !important"><a href="javascript:void(0);"  id="patient_related_iop_remove<?php echo $sl; ?>" onClick="patient_related_remove_iop_del('<?php echo $sl; ?>','<?php echo $row5['id']; ?>')" class="btn btn-sm default" title="OK"><i class="fa fa-times" style="font-size:16px;color:red"></i></a>

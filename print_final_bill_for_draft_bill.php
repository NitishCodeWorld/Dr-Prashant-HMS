          ...
          <div class="portlet light">
            ...
            <div class="row">
                <div class="col-md-12" style="padding-bottom:4px">
                  ...
                  <tr>
                      <td colspan="2"><center><strong style="font-size:12pt !important;text-decoration:underline;"><?php echo "Draft Bill".$cancled;  ?></strong></center></td>   
                    </tr>
                    <tr>
              ...
              <div class="row">
                  ...
                  <table class="ot" style="width:100%" cellpadding="0" cellspacing="0" align="center">
                    <tr>
                     ...
                     <?php		$procedure_amt_tot=0;
								...
								$sql2_lab_proc="SELECT * FROM `invoice_final_procedure_for_draft_bill` WHERE `i_id`= '" .$id. "' AND `patient_registration_id`= '" .$row3['patient_registration_id']. "' AND `hospital_number`= '" .$row3['hospital_number']. "' $condition ";
                ...
                <div class="col-md-12">
				  ...
				  if($del_flag=='1'){
					 ...
					 $sql_lab_payment = "SELECT `invoice_final_payment_billing_for_draft_bill`.* , `payment_mode_masters`.`payment_mode_name`,`payment_type_masters`.`payment_type_name` FROM `invoice_final_payment_billing_for_draft_bill` INNER JOIN `payment_mode_masters` ON `invoice_final_payment_billing_for_draft_bill`.`p_key` =`payment_mode_masters`.`id` INNER JOIN `payment_type_masters` ON `invoice_final_payment_billing_for_draft_bill`.`payment_type` =`payment_type_masters`.`id` WHERE `invoice_final_payment_billing_for_draft_bill`.`i_id` = '".$id."' $condition ";
			$result_lab_payment = $conn->query($sql_lab_payment);
			if($result_lab_payment->num_rows > 0){
				while ($row2_lab_payment=mysqli_fetch_array($result_lab_payment,MYSQLI_ASSOC))
														{

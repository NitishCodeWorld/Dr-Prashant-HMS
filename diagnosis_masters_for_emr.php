...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$diagnosis=mysqli_real_escape_string($conn,$_REQUEST['diagnosis']);

		$code=mysqli_real_escape_string($conn,$_REQUEST['code']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `diagnosis_masters_for_emr` SET `diagnosis`='".$diagnosis."', `code`='".$code."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'diagnosis_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `diagnosis_masters_for_emr`(`code`,`diagnosis`) VALUES ('".$code."','".$diagnosis."')";
...

{
	...
	$sql = "DELETE FROM `diagnosis_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `diagnosis_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Diagnosis Master Details </span></div>
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
                  ...
                  <?php 
				   ...
				   $sql3="SELECT `id`,`code`, `diagnosis` FROM `diagnosis_masters_for_emr` ORDER BY `id` DESC";
                    ...
                    <div class="modal-body">
                      ...
                      <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-title" >
                          ...
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Diagnosis</div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label">Diagnosis Code</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <input type="text" name="code" id="code" class="form-control" placeholder="Enter text" />
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label">Diagnosis Name</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <textarea name="diagnosis" id="diagnosis" class="form-control" placeholder="Enter text" required></textarea>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/diagnosis_ajax_for_emr.php",

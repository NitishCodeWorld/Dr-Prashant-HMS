...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$purpose_name=mysqli_real_escape_string($conn,$_REQUEST['purpose_name']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `procedure_purpose_masters_for_appt` SET `purpose_name`='".$purpose_name."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'procedure_purpose_masters_for_appt.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `procedure_purpose_masters_for_appt`(`purpose_name`) VALUES ('".$purpose_name."')";
...

{
	...
	$sql = " UPDATE `procedure_purpose_masters_for_appt` SET `del_flag`='1' WHERE `id`='".$_REQUEST['delete']."' ";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `procedure_purpose_masters_for_appt`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Procedure Purpose Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `purpose_name` FROM `procedure_purpose_masters_for_appt` WHERE `del_flag`='0' ORDER BY `id` DESC";
...

				 {
                  ...
                  <tr >
                    ...
                    <td><?php echo $row3['purpose_name']; ?></td>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-title" >
                          ...
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Procedure Purpose</div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label">Procedure Purpose Name</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <input type="text" name="purpose_name" id="purpose_name" class="form-control" placeholder="Enter text" required/>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/procedure_purpose_ajax_for_emr.php",
						...
						success : function(data) {						
							...
							try{
								 ...
								 $("#purpose_name").val(data.purpose_name);

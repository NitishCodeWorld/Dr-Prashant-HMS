...
<head>
<meta charset="utf-8"/>
<title>Sale Final Invoice</title>
      ...
      <div class="portlet light">
        <div class="portlet-body">
		  ...
		  $inv_id=$_GET['inv_id'];
			...
			if($purch_invoice=="0")$sql="select pharma_invoice_for_optical.*,pharma_invoice_for_optical.status as `status_` from pharma_invoice_for_optical  where pharma_invoice_for_optical.id='".$inv_id."'";
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="print_size">
              ...
              <tr>
                ...
                <td width="17%" style="text-align:center; vertical-align:top !important"><?php if($purch_invoice=="0"){ ?>
                  <h4 class="print_size"><strong>FINAL TAX INVOICE</strong></h4>
                ...
                <th colspan="4" scope="row"> <table class="table table-striped table-bordered table-hover" width="100%" id="main_body">
                    ...
                    <tbody>
                      <?php
							$mrp_total=0;
							 if($purch_invoice=="0"){ 
								$sql="select sd.*,sd.qty as `quanitity`,pm.* from pharma_invoice_details_for_optical as sd inner join item_master_for_optical as pm on sd.item_id=pm.id where sd.sales_id='".$inv_id."'";

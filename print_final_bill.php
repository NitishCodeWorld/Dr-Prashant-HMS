...
?>
<?php include "header_for_bill_print.php"; ?>
                ...
                <div class="col-md-12" style="padding-bottom:4px">
                  <table class="ott" style="width:100%" cellpadding="0" cellspacing="0" align="center">
                    <tr>
                      ...
                      <td width="47%" style="text-align:right !important;">AGE: <strong><?php echo $row3['age'];  ?> YEARS</strong></td>
                    </tr>
                    
                    <tr>
                      <td colspan="2">UHID No.: <strong><?php echo $row3['hospital_number'];  ?></strong></td>                      
                      <td  width="47%"  style="text-align:right !important;">CONSULTANT: <strong><?php 
				...
				while ($row2_lab_payment=mysqli_fetch_array($result_lab_payment,MYSQLI_ASSOC))
														{
															...
															/*if($row2_lab_payment['p_key']=='6'){
															$qry_tpa = mysqli_query($conn, "SELECT  `name` FROM `patient_type_master` WHERE  `id`='".$row2_lab_payment['tpa_name']."'"); 
															$row3_tpa = mysqli_fetch_array($qry_tpa); 
															 $tpa_name_fetch=$row3_tpa['name'];
															}*/
...
<?php include "footer_for_bill_print.php" ?>
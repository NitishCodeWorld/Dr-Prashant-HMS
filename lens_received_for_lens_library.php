...
<div class="page-container"> 
  ...
  ?>
      ...
      <div class="row">
        ...
        <?php 
                $sql_="select * from `lens_recieved_for_lens_library`";
...
function save_sales(flag=0){
	...
	$.ajax({
            ...
            url: 'get_json_data_for_lens_library.php?flag=44',
...
function load_sale_order_details(cou_pag_no){
	...
	$.ajax({
            url: 'get_json_data_for_lens_library.php?flag=54',
			dataType: 'json',
			type: 'POST',
			data:data_details,
			success: function (data) {

    ...
    <div class="container-fluid"> 
              ...
              <div class="row" style="background:#dcefff; padding:9px 0px"> 
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="supplier_invoice_no" value="<?php echo date("dmY/Hi"); ?>" />
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="">Purchase Bill Date (dd-mm-yyyy)</label>
                    <input name="purchase_bill_date" id="purchase_bill_date" value="<?php echo date("d-m-Y"); ?>"  type="text" class="form-control">
                  </div>
                </div>
          ...
          <table class="table table-striped table-bordered table-hover small" id="asset_entry_data">
            ...
            <thead>
              <tr>
                ...
                <th class="draggable" data-column="cat_name" style="cursor: move;"><span>Category Name </span></th>
                <th class="draggable" data-column="sub_cat_name" style="cursor: move;"><span>Sub Category Name </span></th> 
                <th class="draggable right" data-column="size" style="cursor: move;"><span>GST % </span></th>
      ...
      <div class="row">
        <div class="col-md-12" style="overflow:auto">
          <table class="table table-striped table-bordered table-hover small" id="asset_entry_data1">
            ...
            <tfoot>
              ...
              <tr style="font-weight:bold;font-size:15px;">
                <td colspan="9" align="right">Add: CGST</td>
                <td><span id="CGST_amount_"></span></td>
                <td></td>
              </tr>
              <tr style="font-weight:bold;font-size:15px;">
                <td colspan="9" align="right">Add: SGST</td>
                <td><span id="SGST_amount_"></span></td>
                <td></td>
              </tr>
              <tr style="font-weight:bold;font-size:15px;">
                <td colspan="9" align="right">Net Total</td>
                <td><span id="net_total_"></span></td>
                <td></td>
              </tr>
               <tr style="font-weight:bold;font-size:15px;">
                <td colspan="7" align="right">Adjusted Amount</td>
        ...
        <!--<div class="col-md-12" style="text-align:center; margin-bottom:10px">
          <input type="button" class="btn" onClick="check_calculate()" id="check_calculate" value="Calculate" style="background:#a51304;color:#FFFFFF;width:120px" />
          <input type="hidden" name="check_enable" id="check_enable" value="0" />
        ...
        <table class="table table-bordered table-striped" id="invoices" role="grid" aria-describedby="product_list_info">
          <thead>
            ...
            <th class="hidden-380" style="text-align:center"> Sl no. </th>
              ...
              <th class="hidden-380" style="text-align:center"> Total Amount ( &#2352; ) </th>
...
//function add_indent(id,indent_id,indent_details_id,item_id,iop_count){ function add_indent(id,indent_id,indent_details_id,item_id){
function add_indent(id,indent_id,indent_details_id,item_id,iop_count){
	
	//alert("ani");
	//alert(iop_count);
	var total_iop=parseInt(iop_count)+1;
	$("#iop_count").val(total_iop);
	var vendor_name_check=$("#vendor_name").val();
	
	if(vendor_name_check==""){
	...
	var tds = $(src).find("td[id='"+id+"_qty_qty_new']");
	//alert(id);
...
function save_purchase(flag=0){
	...
	$("#asset_entry_data1 > tbody  > tr").each(function( index, val ){
		...
		qty[i]=$("#"+$( this ).attr('id')+"_qty_qty").val();
	...
	$.ajax({
            ...
            url: 'get_json_data_inventory.php?flag=63',
			type: 'POST',
			dataType: 'json',
			data: data_details,
			success: function (data) {
...
function calculate(id){
	...
	let sgst=0;
	let net_total=0;
	console.log(($("#"+id+"_rate").val())*($("#"+id+"_qty_qty").val()));
	console.log("Discount Rate::"+$("#"+id+"_discount_rate").val());
	$("#"+id+"_total_amount").val(($("#"+id+"_rate").val())*($("#"+id+"_qty_qty").val()));
	...
	var net_amount=net_total.toFixed(2);
	$("#net_total_").html(net_amount);
	$("#grand_net_total_").html(net_total);
}

/*function qty_change(id){
	var qty=$("#"+id+"_qty_values").val();
	$("#"+id+"_qty_qty").html(qty);
...
$.ajax({
            ...
            url: 'get_json_data_inventory.php?flag=62',
			type: 'POST',
			data: data_details,
			success: function (data) {

      ...
      <div class="col-md-12"> 
        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase" id="title_span">Pushpanjali collection Reports MIS </span></div>
          ...
          <div class="portlet-body">
            ...
            <div class="table-toolbar">
              <div class="col-md-12">
                <div class="col-md-3">
                  <input type="text" class="form-control" placeholder="Select From Date" id="from_date" name="from_date" value="<?php echo date("d-m-Y"); ?>" onChange="date_change();"/>
                  <input type="hidden" class="form-control" placeholder="Select To Date" id="to_date" name="to_date" value="<?php echo date("d-m-Y"); ?>" />
                </div>
                <!--<div class="col-md-3">
...
function date_wise_db(){
	...
	var print_url="<?php echo ADMIN_URL.'consolidated_report_full_fecth.php?from_date=';  ?>"+from_date+"<?php echo '&to_date=';  ?>"+to_date;

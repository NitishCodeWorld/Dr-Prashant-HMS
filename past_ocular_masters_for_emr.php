...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$past_ocular_text=mysqli_real_escape_string($conn,$_REQUEST['past_ocular_text']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `past_ocular_masters_for_emr` SET `past_ocular_text`='".$past_ocular_text."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'past_ocular_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `past_ocular_masters_for_emr`(`past_ocular_text`) VALUES ('".$past_ocular_text."')";
...

{
	...
	$sql = "DELETE FROM `past_ocular_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `past_ocular_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Past Ocular Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `past_ocular_text` FROM `past_ocular_masters_for_emr` ORDER BY `id` DESC";
...

				 {
                  ...
                  <tr >
                    ...
                    <td><?php echo $row3['past_ocular_text']; ?></td>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-title" >
                          ...
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Past Ocular</div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label">Past Ocular Name</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <textarea name="past_ocular_text" id="past_ocular_text" class="form-control" placeholder="Enter text" required></textarea>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/past_ocular_ajax_for_emr.php",
						...
						success : function(data) {						
							...
							try{
								 ...
								 $("#past_ocular_text").val(data.past_ocular_text);

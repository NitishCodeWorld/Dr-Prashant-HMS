<?php
include 'conn.php';
$discharge_id=$_GET['est_id'];

if($discharge_id!=''){
	$deleted_time=date('Y-m-d H:i:s');
	$deleted_by=$_SESSION['id'];
	
	$sql="UPDATE estimation_form_details set `del_flag`='1',`deleted_time`='".$deleted_time."',`deleted_by`='".$deleted_by."' where id='".$discharge_id."'";
      ...
      <div class="col-md-12"> 
        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Estimation Record</span></div>
          ...
          <div class="portlet-body">
            ...
            <div class="table-toolbar">
              ...
              <div class="col-md-12">
                <span style="float:left;margin:10px;"><a href="estimation_form_billing.php" title="Add Estimation Form" class="btn btn-sm red">Add Estimation Form</a></span>
              </div>
                ...
                <table class="table table-striped table-hover table-bordered" id="asset_entry_data">
                  <thead>
                    <tr>
                      ...
                      <th class="draggable" data-column="asset_name" style="cursor: move;">Estimation Date / Time</th>
                       <th class="draggable" data-column="asset_name" style="cursor: move;">Total</th>
...
if(tab_asset_entry!="") tab_asset_entry.destroy();
	...
	$.ajax({
            url: 'get_json_data_for_ipd_details.php?flag=8',
			dataType: 'json',
			data: data_details,
			type: 'POST',
			beforeSend: function(){
			 ...
			 $('#assets_body').html('');
			  $.each(data, function(index, element) {
			    var background_color="style='background-color: "+element.rowclass+";'";  
			 	$('#assets_body').html($('#assets_body').html()+'<tr '+background_color+'><td>'+element.sl_no+'</td><td><b>Name: '+element.prefix+' '+element.patient_name+'<br>'+element.mobile_prefix+' '+element.mobile+'<br>'+element.age+'( '+element.gender+' )'+'</b></td><td><b>'+element.admiting_doctor+'</b></td><td><b>'+element.billing_date+' '+element.billing_time+'</b></td><td><b>'+element.total+'</b></td><td>'+element.action_tab+'</td></tr>');

    ...
    <div class="container-fluid"> 
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-blue-sharp"></i> <span class="caption-subject font-blue-sharp bold uppercase">Pharmacy Billing</span></div>
            </div>
            <!-- BEGIN FORM--> 
          ...
          <div class="portlet" style="min-height:50px; margin-bottom:0px">
            <div class="portlet-body">
              <div class="col-md-2" style="margin-top:8px; font-weight:bold; text-align:right; padding-right:0px; margin-left:-59px;">Enter Patient UHID No.: &nbsp;&nbsp;</div>
              ...
              <div class="col-md-3" id="prescribe_div_btn" style="display:none;">
                <button class="btn-circle btn blue" onClick="view_medicine_details();view_medicine_prescribe_details();" id="medicine_presc_btn">View Prescribe Medicine</button>
              </div>
              ...
              <div class="col-md-3" style="padding-left:0px; padding-right:2px">
                ...
                <input type="hidden" class="form-control" placeholder="Enter UHID" name="treat_flag" id="treat_flag" value="<?php if(isset($_REQUEST['treat_flag'])){ echo $_REQUEST['treat_flag'];}else{ echo '0';}?>" />
              </div>
              <div class="col-md-3" style="padding-left:0px; padding-right:2px">
              ...
              <div class="col-md-3" style="padding-left:0px; padding-right:2px">
                ...
                <br />
                <select id="doctors" class="form-control" style="width:300px">
              ...
              <div class="col-md-3" style="padding-left:0px; padding-right:2px">
                ...
                <span id="patient_admit"></span> </div>
            </div>
          </div>
        ...
        <div class="col-md-12" style="overflow:auto">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <select class="form-control item select2" id="item" onChange="load_batch_codes()" >
              </select>
            </div>
          </div>
          <div class="col-md-2">
          ...
          <div class="col-md-2" style="margin-top:25px">
            <button class="btn green" id="add_item_btn" onClick="add_item()" disabled >Add Item</button>
          </div>
        ...
        <div class="col-md-12" id="prescribed_div_medicine" style="display:none;" >
          <table class="table table-striped table-bordered table-hover small" id="pharma_order_data1">
            <div style="margin-top:20px !important;">
              <center>
                <h3><u> Prescribe Medicine List
                  <?php if(isset($_REQUEST['treat_flag'])){ if($_REQUEST['treat_flag']=='1'){ echo 'From Treatment Sheet';}else if($_REQUEST['treat_flag']=='2'){ echo 'From Stat Sheet';}else{ echo 'From Discharge Sheet';}}?>
                  </u></h3>
              </center>
            </div>
            <caption>
            ...
            <thead>
              <tr>
                ...
                <th class="draggable" data-column="asset_name" style="cursor: move;"><span>From Which Sheet Prescribed </span></th>
      ...
      <div class="row">
        ...
        <div class="col-md-12" style="text-align:center; margin-bottom:10px">
          ...
          <input type="button" class="btn" id="submit_save_btn" onClick="save_sales()" value="Save Sales" style="background:#000099;color:#FFFFFF;width:120px" />
          &nbsp;&nbsp;
          <input type="button" class="btn" id="submit_print_btn" onClick="save_sales(1)" value="Save & Print" style="background:#000099;color:#FFFFFF;width:120px" />
          &nbsp;&nbsp;
...
<?php if(isset($_REQUEST['hospital_number'])){ ?>
//$("#medicine_presc_btn").click();
<?php } ?>
...
function add_item(){
	...
	if(search_code($("#batch_code_val").find(":selected").val())==true){			
		...
		alert("Item Added. Please click on OK and Go On.... ");
...
function save_sales(flag=0){
	...
	$.ajax({
			beforeSend: function(){
			  $('.ajax-loader').css("visibility", "visible");
			  $("#submit_save_btn").prop( "disabled", true );
             $("#submit_print_btn").prop( "disabled", true );
			},
            url: 'get_json_data_inventory.php?flag=43',
			type: 'POST',
			dataType: 'json',
			data: data_details,
			success: function (data) {
			 ...
			 complete: function(){
			  $('.ajax-loader').css("visibility", "hidden");
			  $("#submit_save_btn").prop( "disabled", false );
             $("#submit_print_btn").prop( "disabled", false );
			}
...
function load_purchase(){
	...
	$.ajax({
			...
			url: 'get_json_data_inventory.php?flag=44',
			type: 'POST',
			success: function (data) {
...
function add_indent_sale_pharma(order_id,sub_type_name,item_id,item_name1,qty,select_option_val)
{

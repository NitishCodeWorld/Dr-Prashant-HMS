        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-blue-sharp"></i> <span class="caption-subject font-blue-sharp bold uppercase">Pharmacy Billing Return For Walk In Customer</span></div>
               
               <span style="float:right !important;" class="caption-subject font-green-sharp bold uppercase"> <a style="color:red !important;"  href="<?php echo ADMIN_URL; ?>pharma_invoice_return.php" class="iconify" title="Inside Patient Medicine Return"> <img src="<?php echo ADMIN_URL; ?>icon/right_hand_arrow.png"  title="Inside Patient Medicine Return"> Inside Patient Medicine Return </a> </span>
        ...
        <div class="row">
          <div class="col-md-12" style="overflow:auto">
            ...
            <div class="col-md-2" style="margin-top:25px">
              <button class="btn green" onClick="add_item()" id="sent_add_item">Add Item</button>
            </div>
            <input type="hidden" name="iop_count" id="iop_count" value="2" />
          </div>
          <div class="col-md-12" id="prescribed_div_medicine"  >
            <table class="table table-striped table-bordered table-hover small" id="pharma_order_data1">
              ...
              <thead>
                <tr>
                  ...
                  <th class="draggable" data-column="asset_name" style="cursor: move;"><span>Sale Date </span></th>
                  <th class="draggable" data-column="asset_name" style="cursor: move;"><span>Customer Name </span></th>
                  <th class="draggable" data-column="asset_name" style="cursor: move;"><span>Customer Mobile </span></th>

...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$gp_name=mysqli_real_escape_string($conn,$_REQUEST['gp_name']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `gp_masters_for_emr` SET `gp_name`='".$gp_name."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'gp_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `gp_masters_for_emr`(`gp_name`) VALUES ('".$gp_name."')";
...

{
	...
	$sql = "DELETE FROM `gp_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `gp_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">GP Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `gp_name` FROM `gp_masters_for_emr` ORDER BY `id` DESC";
                    ...
                    <div class="modal-body">
                      ...
                      <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-title" >
                          ...
                          <div class="caption"> <i class="fa fa-gift"></i>Add New GP</div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label">GP Name</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <input type="text" name="gp_name" id="gp_name" class="form-control" placeholder="Enter text" required/>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/gp_ajax_for_emr.php",

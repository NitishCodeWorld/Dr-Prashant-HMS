...
<div class="page-container">
  <div class="page-content">
	...
	$purch_invoice=0 ;
	if($purch_invoice=="0") $sql="select stock_transfer.*,department_master.department_name,stock_transfer.status as `status_` from stock_transfer left join department_master on department_master.id=stock_transfer.to_department_id where stock_transfer.id='".$inv_id."'";
                ...
                <table class="table table-striped table-hover" style="margin-bottom:0px" id="main_body">
                  ...
                  <tbody>
                    <?php
									$mrp_total=0;
									 if($purch_invoice=="0"){ 
										$sql="select sd.*,sd.qty as `quanitity`,pm.* from stock_transfer_details as sd inner join item_master as pm on sd.item_id=pm.id where sd.stock_transfer_id='".$inv_id."'";
                    ...
                    <tr style="text-align:center">
                      <td><?php echo $sl; ?></td>
                      <td><?php echo strip_tags($row_['item_name']); ?> ( <?php echo $row_['batch_no']; ?> <?php echo ($row_['expiry_date']=="0000-00-00" || $row_['expiry_date']=="1970-01-01") ? "" : "Expiry Date: ".date("d-m-y",strtotime($row_['expiry_date'])); ?> <?php echo ($row_['manufacturing_date']=="0000-00-00" || $row_['manufacturing_date']=="1970-01-01") ? "" : "Mfg Date: ".date("d-m-y",strtotime($row_['manufacturing_date'])); ?> )</td>
            ...
            <div class="row">
              <div class="col-xs-4">
                <div class="well">
                  <address>
                  E & O E
                  For PARIJAT SEVALAY (P) Ltd. <br>
                  <?php if($total_discount_amount>0) echo "You saved &#8377".$total_discount_amount; ?>
                  <br>
              ...
              <div class="col-xs-8 invoice-block">
                <ul class="list-unstyled amounts">
                  ...
                  <li> <strong>Grand Total:</strong> &#8377;<?php echo $total_amount; ?> </li>
                </ul>
                <br/>
                <ul>
                  <li></li>
                ...
                <?php
								...
								?>
                <button class="btn red hidden-print" type="button" onClick="cancel_bill()">Cancel Transfer &nbsp; <i class="fa fa-close"></i></button>
                <?php } ?>

...
if(isset($_REQUEST['submit']))
{
	...
	if($_REQUEST['id']!=''){	
		...
		$sql = "UPDATE `patient_category_master` SET `name`='".$name."',`modified_by`='".$modified_by."' ,`modified_time`='".$modified_time."' WHERE `id`='".$id."'";
		if($conn->query($sql)===TRUE)
		{
		$msg="Record updated successfully";
		$flg=0;
		$redirectUrl=ADMIN_URL.'patient_category_master.php?msg='.$msg.'&flg='.$flg;
	...
	//Add Data
		...
		$sql = "INSERT INTO `patient_category_master` SET `name`='".$name."',`created_by`='".$created_by."',`created_on`='".$created_on."'";
		if($conn->query($sql)===TRUE)
		{
		$flg=0;
...
if(isset($_REQUEST['delete']))
{
	...
	$sql = "UPDATE `patient_category_master` SET `del_flag`='1',`deleted_by`='".$deleted_by."',`deleted_time`='".$deleted_time."' WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <!-- END PAGE HEAD --> 
   			 <?php 
				 ...
				 //$today=date('Y-m-d');
				 $total_count=0;
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `patient_category_master` WHERE `del_flag`='0'";
				$result=$conn->query($sql) ;				
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Patient Master</span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
                  <?php 
				  $sql3="SELECT `id`, `name`,`created_by`,`created_on`,`modified_by`,`modified_time`,`del_flag`,`deleted_by`,`deleted_time` FROM `patient_category_master` WHERE `del_flag`='0' ORDER BY `id` DESC";
                      ...
                      <div class="modal-content"> 
                        ...
                        <div class="modal-body">
                          <div class="portlet box blue-hoki">
                            <div class="portlet-title" >
                              <div class="caption"> <i class="fa fa-gift"></i>Add New Agent</div>
                            </div>
                              ...
                              <form action="" method="post" class="form-horizontal">
                                <div class="form-body">
                                  <div class="form-group">
                                    <label class="col-md-4 control-label">Patient Category</label>
                                    <div class="col-md-7">
                                      <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter text" autocomplete="off" required/>
...
try{
		...
		$.ajax({
						type : "POST",
						url : "<?php echo ADMIN_URL; ?>ajax/patient_category_master_ajax.php",
						dataType : "json", 
						data : "id="+id,

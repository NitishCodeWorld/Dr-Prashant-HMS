...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$sql = "UPDATE `fundus_masters_for_emr` SET `fundus`='".$fundus."' WHERE `id`='".$id."'";
		...
		header("location:".ADMIN_URL."fundus_masters_for_emr.php?msg=".$msg."&flg=".$flg);
	...
	//Edit Data
		...
		$sql = "INSERT INTO `fundus_masters_for_emr`(`fundus`) VALUES ('".$fundus."')";
...

{
	...
	$sql = "DELETE FROM `fundus_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `fundus_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Fundus Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `fundus` FROM `fundus_masters_for_emr` ORDER BY `id` DESC";
                    ...
                    <div class="modal-body">
                      ...
                      <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-title" >
                          ...
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Fundus</div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label">Fundus Name</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <textarea name="fundus" id="fundus" class="form-control" placeholder="Enter text" required></textarea>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/fundus_ajax_for_emr.php",

...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="3" style="border: 2px solid #333; padding:6px; text-align:center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td style="padding-left:4px; border-bottom: 1px solid #333;" colspan="3"><?php 
        ...
        <tr>
          ...
          <td style="border-bottom: 1px solid #333; padding-left:4px" colspan="3"><?php echo $payor_name;  ?></td>
        </tr>
      </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3" style="text-align:left; vertical-align:top;font-size:18px;"><strong>Received Amount : Rupees <?php echo number_format(($row3['total']),2);?> Only</strong></td>
  </tr>
  <tr>
    <td colspan="3" style="text-align:left; vertical-align:top;font-size:18px;"><strong>Received With Thanks Rupees <?php echo ucwords(convertNumber($row3['total']));?> Only. By <?php echo $pay_mode;  ?></strong></td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>

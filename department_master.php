        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-blue-sharp"></i> <span class="caption-subject font-blue-sharp bold uppercase">Department Creation</span></div>
            </div>
            <!-- BEGIN FORM-->
              ...
              <div class="row" style="background:#dcefff; padding:9px 0px">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="text" id="department_name_" name="department_name_" class="form-control" placeholder="Name">
                    </div>
                  </div>
...
function save_asset(){
	if($("#department_name_").val()==''){
		alert("Please Fill up");
		return false;	
	}
	var data_details={
		"dept_name": $("#department_name_").val(),
		"id": $("#id").val()
	}
	var edit_flag=0;
		$.ajax({
...
if(confirm("Are you sure you want to delete the data?")){
	$.ajax({
			...
			type: 'POST',
			data: "id="+id+"&table=department_master",
			success: function (data) {
...
function edit(id,text){
	...
	$("#id").val(id);
	$("#department_name_").val(text);
	$("#department_name_").focus();

...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$general_health_text=mysqli_real_escape_string($conn,$_REQUEST['general_health_text']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `general_health_masters_for_emr` SET `general_health_text`='".$general_health_text."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'general_health_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `general_health_masters_for_emr`(`general_health_text`) VALUES ('".$general_health_text."')";
...

{
	...
	$sql = "DELETE FROM `general_health_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <!-- END PAGE HEAD --> 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `general_health_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">General Health Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `general_health_text` FROM `general_health_masters_for_emr` ORDER BY `id` DESC";
...

				 {
                   ...
                   <tr >
                    ...
                    <td> <?php echo $row3['general_health_text']; ?></td>                    
                        ...
                        <div class="modal-body">
                          ...
                          <div class="portlet box blue-hoki">
                            ...
                            <div class="portlet-title" >
                              ...
                              <div class="caption"> <i class="fa fa-gift"></i>Add New General Health</div>
                              ...
                              <form action="" method="post" class="form-horizontal">
                                ...
                                <div class="form-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <label class="col-md-4 control-label">General Health Name</label>

                                    <div class="col-md-7">

                                      <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                      <textarea name="general_health_text" id="general_health_text" class="form-control" placeholder="Enter text" required></textarea>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/general_health_ajax_for_emr.php",
						...
						success : function(data) {						
							...
							try{
								 ...
								 $("#general_health_text").val(data.general_health_text);

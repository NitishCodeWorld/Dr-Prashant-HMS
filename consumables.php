        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-blue-sharp"></i> <span class="caption-subject font-blue-sharp bold uppercase">Enter Consumables</span></div>
            </div>
            <!-- BEGIN FORM--> 
...
function save_sales(flag=0){
	...
	$.ajax({
            ...
            url: 'get_json_data_inventory.php?flag=56',
			type: 'POST',
			dataType: 'json',
			data: data_details,
			success: function (data) {
...
function load_purchase(){
	...
	$.ajax({
			...
			url: 'get_json_data_inventory.php?flag=80',
			type: 'POST',
			success: function (data) {

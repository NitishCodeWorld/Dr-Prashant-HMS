              ...
              <div class="row" style="background:#dcefff; padding:9px 0px">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input name="moq" id="moq" type="text" class="form-control">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
  ...
  <div class="row">
    <div class="col-md-12" style="overflow:auto">
      ...
      <?php 
			...
			$sql_="select * from `item_master_for_optical` where asset_name<>'' and `status`<>2";
...
function load_item(cou_pag_no){
	...
	$('#assets_body').html("");
	/*var table = $('#asset_entry_data').DataTable();
table.clear().draw();*/
	...
	$.ajax({
            ...
            url: 'get_json_data_for_optical.php?flag=8',
			dataType: 'json',
			type: 'POST',
			data:data_details,
			success: function (data) {
				...
				$('#assets_body').html("");
				 $.each(data, function(index, element) {
					html +='<tr><td>'+element.id+'</td><td>'+element.asset_name+'</td><td>'+element.type_id+'</td><td>'+element.sub_type_id+'</td><td>'+element.size+'</td><td>'+element.color+'</td><td>'+element.gst_rate+' %</td><td>'+element.mrp+'</td><td>'+element.action+'</td></tr>';
				});
...
$(document).ready( function () {
	...
	$("#header_h").html("<b>OPD Invoice Wise Report On "+from_date+"</b>");
	document.title = "OPD Invoice Wise Report  On "+from_date;
	}else{
		$("#header_h").html("<b>OPD Invoice Wise Report From "+from_date+" To "+to_date+"</b>");
		document.title = "OPD Invoice Wise Report From "+from_date+" To "+to_date;
	}
	*/

...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$misc_eye_test_name=mysqli_real_escape_string($conn,$_REQUEST['misc_eye_test_name']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `miscellaneous_eye_test_masters_for_emr` SET `misc_eye_test_name`='".$misc_eye_test_name."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'miscellaneous_eye_test_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `miscellaneous_eye_test_masters_for_emr`(`misc_eye_test_name`) VALUES ('".$misc_eye_test_name."')";
...

{
	...
	$sql = "UPDATE `miscellaneous_eye_test_masters_for_emr` SET  `del_flag`='1', `deleted_by`='".$created_by."', `deleted_time`='".$today."'  WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `miscellaneous_eye_test_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Miscellaneous Eye Test Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `misc_eye_test_name` FROM `miscellaneous_eye_test_masters_for_emr` WHERE `del_flag`='0' ORDER BY `id` DESC";
...

				 {
                  ...
                  <tr >
                    <td><?php echo $id; ?></td>
                    <td><?php echo $row3['misc_eye_test_name']; ?></td>
                  ...
                  <div class="modal-content"> 
                    ...
                    <div class="modal-body">
                      <div class="portlet box blue-hoki">
                        <div class="portlet-title" >
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Miscellaneous Eye Test</div>
                        </div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            <div class="form-body">
                              <div class="form-group">
                                <label class="col-md-4 control-label">Miscellaneous Eye Test Name</label>
                                <div class="col-md-7">
                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                    <input type="text" name="misc_eye_test_name" id="misc_eye_test_name" class="form-control" placeholder="Enter text" required/>
...
function check(id){
		$.ajax({
			type : "POST",
			url : "<?php echo ADMIN_URL; ?>ajax_for_emr/misc_eye_test_ajax_for_emr.php",
			dataType : "json", 
			data : "id="+id,
			success : function(data) {
					 $('#draggable').modal('show'); 	
					 $("#misc_eye_test_name").val(data.misc_eye_test_name);
					 $("#id").val(data.id);							
			}

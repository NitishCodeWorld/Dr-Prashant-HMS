...
if(tab_asset_entry!="") tab_asset_entry.destroy();
	...
	$.ajax({
            ...
            url: 'get_json_data_for_report_details.php?flag=2',
			...
			//$("#loader").show();
			$('#assets_body').html($('#assets_body').html()+'<tr><td colspan="15" style="text-align:center"><img src="loader.gif" style="width:50px" /></td></tr>');		
			...
			success: function (data) {
			 ...
			 var paid_grand_total=0;
			 var advance_grand_total=0;
			 var due_grand_total=0;
			 var print_url="";
			  $.each(data, function(index, element) {
				  if(element.opd_flag=='0'){	
			  		 print_url="<?php echo ADMIN_URL.'print_final_bill_for_ipd_new.php?id=';  ?>"+element.id;
				  }else{
					print_url="<?php echo ADMIN_URL.'print_final_bill_for_opd_new.php?id=';  ?>"+element.id;  
				  }
					if(element.sl_inner=='1'){
						$('#assets_body').html($('#assets_body').html()+'<tr ><td class="defualt_td bord_top">&nbsp;</td><td class="bold_td bord_top">'+element.procedure_name+'</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td><td class="defualt_td bord_top">&nbsp;</td></tr>');
					}
						  
					$('#assets_body').html($('#assets_body').html()+'<tr ><td class="defualt_td">'+element.sl_inner+'</td><td class="defualt_td"><a href="'+print_url+'" target="_blank" title="Bill Print" style="color:#0a5595 !important;">'+element.bill_no+'</a></td><td class="defualt_td">'+element.billing_date+'</td><td class="defualt_td">'+element.hospital_number+'</td><td class="defualt_td">'+element.prefix+' '+element.name+'</td><td class="defualt_td">'+element.primary_doctor+'</td><td class="defualt_td">'+element.amount+'</td><td class="defualt_td">'+element.discount+'</td><td class="defualt_td">'+element.net_amount+'</td><td class="defualt_td">'+element.advance_amt+'</td><td class="defualt_td">'+element.adjamt+'</td><td class="defualt_td">'+element.advance_amt_ret+'</td><td class="defualt_td_spcl">'+element.pay_mode+'</td><td class="defualt_td_spcl">'+element.due_amt+'</td><td class="defualt_td_spcl">'+element.payor_name+'</td></tr>');
				// '+element.paid_advance_total+'
				if(element.sl_inner==element.count_inner){
					$('#assets_body').html($('#assets_body').html()+'<tr ><td class="defualt_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="defualt_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">Total:</td><td class="defualt_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">'+element.amount_net_total+'</td><td class="bold_td bord_bott">'+element.discount_net_total+'</td><td class="bold_td bord_bott">'+element.paid_net_total+'</td><td class="bold_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="defualt_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="defualt_td bord_bott">&nbsp;</td></tr>');
					amount_grand_total=parseInt(amount_grand_total)+parseInt(element.amount_net_total);
					discount_grand_total=parseInt(discount_grand_total)+parseInt(element.discount_net_total);
					paid_grand_total=parseInt(paid_grand_total)+parseInt(element.paid_net_total);
					advance_grand_total=parseInt(advance_grand_total)+parseInt(element.paid_advance_total);
					due_grand_total=parseInt(due_grand_total)+parseInt(element.due_net_total);
					 title_span=element.title_span;
				}
				
		 	});
			// '+advance_grand_total+'
			$('#assets_body').html($('#assets_body').html()+'<tr ><td class="defualt_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="defualt_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">Total IPD Billng:</td><td class="defualt_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">'+amount_grand_total+'</td><td class="bold_td bord_bott">'+discount_grand_total+'</td><td class="bold_td bord_bott">'+paid_grand_total+'</td><td class="bold_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="defualt_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="defualt_td bord_bott">&nbsp;</td></tr>');

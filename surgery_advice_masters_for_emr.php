...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$surgery_advice=mysqli_real_escape_string($conn,$_REQUEST['surgery_advice']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `surgery_advice_masters_for_emr` SET `surgery_advice`='".$surgery_advice."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'surgery_advice_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `surgery_advice_masters_for_emr`(`surgery_advice`) VALUES ('".$surgery_advice."')";
...

{
	...
	$sql = "DELETE FROM `surgery_advice_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `surgery_advice_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Surgery Advice Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `surgery_advice` FROM `surgery_advice_masters_for_emr` ORDER BY `id` DESC";
...

				 {
                  ...
                  <tr >
                    ...
                    <td><?php echo $row3['surgery_advice']; ?></td>
                ...
                <div class="modal-dialog" id="model_header">
                  ...
                  <div class="modal-content"> 
                    ...
                    <!-- <div class="modal-header">
                         ...
                         <h4 class="modal-title"><strong>Add New Surgery Advice</strong></h4>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-title" >
                          ...
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Surgery Advice</div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label">Surgery Advice Name</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <textarea name="surgery_advice" id="surgery_advice" class="form-control" placeholder="Enter text" required></textarea>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/surgery_advice_ajax_for_emr.php",
						...
						success : function(data) {						
							...
							try{
								 ...
								 $("#surgery_advice").val(data.surgery_advice);

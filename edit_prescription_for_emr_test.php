                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="table table-striped table-bordered table-advance table-hover">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td width="20%"><select class="form-control" name="past_ocular_place" id="past_ocular_place">
                                    <option value="SFECC">SFECC</option>
                              ...
                              <tr>
                                <td colspan="7" ><textarea id="past_ocular_history" name="past_ocular_history" class="form-control" rows="2" placeholder="Enter Past Ocular History"><?php echo $row['past_ocular_history']; ?></textarea>
                              </tr>
                            </tbody>
                          </table>
                        </div>
...
<script >
        ...
        $(document).ready(function() {
            ...
            $("#past_ocular_btn").click(function() {
				...
				var past_ocular_place = $("#past_ocular_place").val();
                ...
                if (chief_value != '') {
					if(chief_eye==''){
                    	...
                    	final_value = chief_value + " ; " + chief + " " + chief_num + " " + chief_dur + " " + past_ocular_year+ " " + past_ocular_place;
					}else{
						final_value = chief_value + " ; " + chief_eye + " - " + chief + " " + chief_num + " " + chief_dur + " " + past_ocular_year+ " " + past_ocular_place;
					}

                } else {
					if(chief_eye==''){
                    	final_value =  chief + " " + chief_num + " " + chief_dur + " " + past_ocular_year+ " " + past_ocular_place;
					}else{
						 final_value = chief_eye + " - " + chief + " " + chief_num + " " + chief_dur + " " + past_ocular_year+ " " + past_ocular_place;
					}

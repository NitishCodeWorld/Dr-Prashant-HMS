...
if(isset($_REQUEST['submit']))
{
	...
	if($_REQUEST['id']!=''){	
		...
		$sql = "UPDATE `patient_type_master` SET `name`='".$name."',`modified_by`='".$modified_by."' ,`modified_time`='".$modified_time."' WHERE `id`='".$id."'";
		if($conn->query($sql)===TRUE)
		{
		$msg="Record updated successfully";
		$flg=0;
		$redirectUrl=ADMIN_URL.'patient_type_master.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		//$sql = "INSERT INTO `patient_type_master`(`name`) VALUES ('".$name."')";
		$sql = "INSERT INTO `patient_type_master` SET `name`='".$name."',`created_by`='".$created_by."',`created_on`='".$created_on."' ";	
		if($conn->query($sql)===TRUE)
		{
		$flg=0;
...
{
	//$sql = "DELETE FROM `patient_type_master` WHERE `id`='".$_REQUEST['delete']."'";
	$deleted_by=$_SESSION['id'];
	$deleted_time=date('Y-m-d H:i:s');
	$sql = "UPDATE `patient_type_master` SET `del_flag`='1',`deleted_by`='".$deleted_by."',`deleted_time`='".$deleted_time."' WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
    ...
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        ...
        <ul class="page-breadcrumb breadcrumb">
          <li> <a href="<?php echo ADMIN_URL; ?>patient_type_master.php">Home</a><i class="fa fa-circle"></i> </li>
  ...
  <?php 
				 ...
				 //$today=date('Y-m-d');
				 $total_count=0;
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `patient_type_master`";
				$result=$conn->query($sql) ;				
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Patient Type</span></div>
            ...
            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
              ...
              <tbody>
                <?php 
				  $sql3="SELECT `id`, `name`,`created_by`, `created_on`, `modified_by`, `modified_time`, `del_flag`, `deleted_by`, `deleted_time` FROM `patient_type_master` WHERE  `del_flag`='0' ORDER BY `id` DESC";
                ...
                <div class="modal-content"> 
                  ...
                  <div class="modal-body">
                    <div class="portlet box blue-hoki">
                      <div class="portlet-title" >
                        <div class="caption"> <i class="fa fa-gift"></i>Add / Edit Patient Type</div>
                      </div>
...
try{
		...
		$.ajax({
						type : "POST",
						url : "<?php echo ADMIN_URL; ?>ajax/patient_type_ajax.php",
						dataType : "json", 
						data : "id="+id,

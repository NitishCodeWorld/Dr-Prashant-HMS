...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$prefix_name=mysqli_real_escape_string($conn,$_REQUEST['prefix_name']);

		$default_gender=mysqli_real_escape_string($conn,$_REQUEST['default_gender']);
		...
		$sql = "UPDATE `prefix_masters` SET `prefix_name`='".$prefix_name."',`modified_by`='".$modified_by."' ,`modified_time`='".$modified_time."' ,`default_gender`='".$default_gender."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'prefix_masters.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$default_gender=mysqli_real_escape_string($conn,$_REQUEST['default_gender']);
		$sql = "INSERT INTO `prefix_masters` SET `prefix_name`='".$prefix_name."',`created_by`='".$created_by."',`created_on`='".$created_on."' ,`default_gender`='".$default_gender."'  ";	
...

{
	...
	//$sql = "DELETE FROM `prefix_masters` WHERE `id`='".$_REQUEST['delete']."'";

	$deleted_by=$_SESSION['id'];

	$deleted_time=date('Y-m-d H:i:s');

	$sql = "UPDATE `prefix_masters` SET `del_flag`='1',`deleted_by`='".$deleted_by."',`deleted_time`='".$deleted_time."' WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
    ...
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        ...
        <ul class="page-breadcrumb breadcrumb">
          <li> <a href="<?php echo ADMIN_URL; ?>prefix_masters.php">Home</a><i class="fa fa-circle"></i> </li>
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `prefix_masters`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Prefix</span></div>
            ...
            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
              ...
              <tbody>
                <?php 
				  ...
				  $sql3="SELECT `id`, `prefix_name`,`created_by`, `created_on`, `modified_by`, `modified_time`, `del_flag`, `deleted_by`, `deleted_time`,`default_gender` FROM `prefix_masters` WHERE  `del_flag`='0' ORDER BY `id` DESC";
...

				 {
					 ...
					 $sql12="SELECT `gender` FROM `gender_masters` Where `id`='".$row3['default_gender']."'";
                ...
                <tr >
                  <td><?php echo $id; ?></td>
                  <td><?php echo $row3['prefix_name']; ?></td> 
                  <td><?php echo $default_gender; ?></td>
                ...
                <div class="modal-content"> 
                  ...
                  <div class="modal-body">
                    <div class="portlet box blue-hoki">
                      <div class="portlet-title" >
                        <div class="caption"> <i class="fa fa-gift"></i>Add / Edit Prefix</div>
                      </div>
                      <div class="portlet-body form"> 
                        ...
                        <form action="" method="post" class="form-horizontal">
                          <div class="form-body">
                            <div class="form-group">
                              ...
                              <div class="col-md-7">
                                <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                  <input type="text" name="prefix_name" id="prefix_name" class="form-control" placeholder="Enter text" required/>
                            ...
                            <div class="form-group">   
                              <label class="col-md-4 control-label">Default Gender/Sex</label>
                              <div class="col-md-7">
                                <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                  <select class="form-control" name="default_gender" id="default_gender">                                  
									<?php 
...
$(document).ready( function() {   
	...
	$("#add_new").click(function(){
		var empty='';
		$("#prefix_name").val(empty);
		$("#id").val(empty);
		$("#default_gender").val(1);
	});
...
function check(id){
		$.ajax({
			type : "POST",
			url : "<?php echo ADMIN_URL; ?>ajax/prefix_ajax.php",
			dataType : "json", 
			data : "id="+id,
			success : function(data) {	
					 $('#draggable').modal('show');	
					 $("#prefix_name").val(data.prefix_name);
					 $("#default_gender").val(data.default_gender);
					 $("#id").val(data.id);	

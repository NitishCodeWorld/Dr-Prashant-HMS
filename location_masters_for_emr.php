...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$location_address=mysqli_real_escape_string($conn,$_REQUEST['location_address']);
		...
		$sql = "UPDATE `location_masters_for_emr` SET `location`='".$location."',`location_address`='".$location_address."',`phone_no`='".$phone_no."',`email`='".$email."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'location_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `location_masters_for_emr` SET `location`='".$location."',`location_address`='".$location_address."',`phone_no`='".$phone_no."',`email`='".$email."' ";		
...

{
	...
	$sql = "DELETE FROM `location_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `location_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Chember Location Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `location`, `location_address`, `phone_no`, `email` FROM `location_masters_for_emr` ORDER BY `id` DESC";
...

				 {
                  ...
                  <tr >
                    ...
                    <td><?php echo $row3['location_address']; ?></td>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-title" >
                          ...
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Chamber Location</div>
                          ...
                          <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-7">
                                  ...
                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                    ...
                                    <input type="text" name="location" id="location" class="form-control" placeholder="Enter text" required/>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-7">
                                  ...
                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                    ...
                                    <textarea name="location_address" id="location_address" class="form-control" placeholder="Enter text"></textarea>
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label">Ph. No.</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <input type="text" name="phone_no" id="phone_no" class="form-control" placeholder="Enter text" />
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-7">
                                  ...
                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                    ...
                                    <input type="text" name="email" id="email" class="form-control" placeholder="Enter text"/>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/location_ajax_for_emr.php",

...
if(tab_asset_entry!="") tab_asset_entry.destroy();
	...
	$.ajax({
            ...
            url: 'get_json_data_for_report_details.php?flag=5',
			dataType: 'json',
			data: data_details,
			type: 'POST',
			beforeSend: function(){
			...
			success: function (data) {
			 ...
			 var print_url="";
			  ...
			  if(element.advance_refund=='1'){ 
			  		
			  		 print_url="<?php echo ADMIN_URL.'print_refund_advance_final_bill.php?id=';  ?>"+element.id;
			 	...
			 	$('#assets_body').html($('#assets_body').html()+'<tr ><td class="defualt_td">'+element.sl_inner+'</td><td class="defualt_td"><a href="'+print_url+'" target="_blank" title="Bill Print" style="color:#0a5595 !important;">'+element.bill_no+'</a></td><td class="defualt_td">'+element.hospital_number+'</td><td class="defualt_td">'+element.prefix+' '+element.name+'</td><td class="defualt_td">'+element.advance_amt+'</td><td class="defualt_td">'+element.pay_mode+'</td><td class="defualt_td">'+element.created_by+'</td></tr>');
				amount_grand_total=parseInt(amount_grand_total)+parseInt(element.advance_amt);
				title_span=element.title_span;	
			
		 	});
			
			$('#assets_body').html($('#assets_body').html()+'<tr ><td class="defualt_td bord_bott">&nbsp;</td><td class="defualt_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">Total :</td><td class="bold_td bord_bott">'+amount_grand_total+'</td><td class="bold_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td></tr>');
...
if(tab_asset_entry_for_ipd!="") tab_asset_entry_for_ipd.destroy();
	...
	$.ajax({
			...
			$('#assets_body_for_ipd').html($('#assets_body_for_ipd').html()+'<tr ><td class="defualt_td bord_bott">&nbsp;</td><td class="defualt_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">Total :</td><td class="bold_td bord_bott">'+amount_grand_total+'</td><td class="bold_td bord_bott">&nbsp;</td><td class="bold_td bord_bott">&nbsp;</td></tr>');
			if(amount_grand_total>0){
				$('#title_span').html(title_span);
				//document.title = title_span;
			}

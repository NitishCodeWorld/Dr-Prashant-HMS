...

{
  ...
  $patient_type = mysqli_real_escape_string($conn,$_POST['patient_type']);
	...
	$ref_doctor_id=mysqli_real_escape_string($conn,$_POST['ref_doctor_id']);
	 $register_by_pat_id=mysqli_real_escape_string($conn,$_POST['register_by_pat_id']);

  $edit = mysqli_query($conn,"INSERT INTO `patient_registration_form` SET  `uhid_no`='".$uhid_no."', `prefix`='".$prefix."', `patient_name`='".$patient_name."', `registration_date`=".$registration_date.", `registration_time`=".$registration_time.", `age`='".$age."', `gender`='".$gender."', `phone_no`='".$phone_no."', `email_id`='".$email_id."',`alternate_phone_no`='".$alternate_phone_no."', `address`='".$address."', `zip_code`='".$zip_code."', `district`='".$district."', `admiting_doctor`='".$admiting_doctor."', `patient_type`='".$patient_type."',`dob`=".$dob." , `appt_id`='".$appt_id."', `patient_admission_type`='".$patient_admission_type."', `created_on`='".$today."' , `created_by`='".$created_by."' , `ref_doctor_id`='".$ref_doctor_id."' ");
...

    {
		...
		$old_db_id=mysqli_real_escape_string($conn,$_POST['old_db_id']);	
		if($old_db_id!=''){
			
			$sql6 = $conn->query("UPDATE `patient_registration_form_old_db` SET `reg_for_new_db_flag`='1' where `id`='".$old_db_id."' ");
			
			$sql6 = $conn->query("UPDATE `patient_registration_form` SET `old_db_id`='".$old_db_id."'  where `id`='".$patient_admission_id."' ");
		}
		
		if($register_by_pat_id!=''){
			
			$sql6 = $conn->query("UPDATE `patient_registration_form_by_patient` SET `patient_register_flag`='1',`uhid_no`='".$uhid_no."',`patient_admission_id`='".$patient_admission_id."' where `id`='".$register_by_pat_id."' ");
			
			$sql6 = $conn->query("UPDATE `patient_registration_form` SET `reg_by_patient_flag`='1'  where `id`='".$patient_admission_id."' ");
		}
	 ...
	 if($_REQUEST['kyc_id'.$i]!='')
...

		   {
			  ...
			  $sql4 = $conn->query("INSERT INTO `patient_kyc_document_by_receptionist` SET `patient_admission_id` = '".$patient_admission_id."',`kyc_id` = '".$_REQUEST['kyc_id'.$i]."',`patient_kyc_document_flag` = '1', `created_on`='".$today."' , `created_by`='".$created_by."',`patient_kyc_document_upload` = '".$patient_kyc_document_upload."'");
	 ...
	 if($_REQUEST['kyc_id'.$i]!='')
		...
		$redirectUrlPrint=ADMIN_URL.'print_card.php?id='.$patient_admission_id;
...

    {
        ...
        $redirectUrl=ADMIN_URL.'registration_form_add.php?msg='.$msg.'&flg='.$flg;
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <?php 
					...
					?>
              <div class="caption"> <i class="fa fa-cogs font-blue-sharp"></i> <span class="caption-subject font-blue-sharp bold uppercase">Patient Registration </span> <span class="head_span"> Last MRD No./ UHID No. : <?php echo $last_uhid;?></span></div>
            </div>
            <?php

			$patient_admission_type = $_REQUEST['patient_admission_type']; // get id through query string

			

			if($patient_admission_type=='1'){

				$appt_id = $_REQUEST['appt_id'];

				$qry = mysqli_query($conn,"select * from `opd_schedules_for_appt` where `id`='".$appt_id."'"); // select query

				$row3 = mysqli_fetch_array($qry); // fetch data

				

				$qry_patient_infos = mysqli_query($conn,"select * from `patient_infos_for_appt` where `id`='".$row3['patient_infos_id']."'"); // select query
            ...
            <form  action="" method="post" enctype="multipart/form-data" class="horizontal-form">
              <div class="form-body">
                <div class="row" style="background:#dcefff; padding:9px 0px">
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="hidden" name="appt_id" id="appt_id" class="form-control" value="<?php echo $_GET['appt_id']; ?>" placeholder="Name" >
                      <input type="hidden" name="old_db_id" id="old_db_id" class="form-control" value="<?php echo $_GET['old_db_id']; ?>" placeholder="Name" >
                      <input type="hidden" name="patient_admission_type" id="patient_admission_type" class="form-control" value="<?php echo $_GET['patient_admission_type']; ?>" placeholder="Name" > 
                      <input type="hidden" name="register_by_pat_id" id="register_by_pat_id" class="form-control" value="<?php echo $_GET['register_by_pat_id']; ?>" placeholder="Name" >
                      <input type="hidden" id="patient_infos_id" value="<?php echo $row_patient_infos['id']; ?>" name="patient_infos_id" class="form-control" placeholder="Patient Name">
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="text" id="patient_name" value="<?php echo $row_patient_infos['name']; ?>" name="patient_name" class="form-control proper_case_div" onblur="case_convrt('patient_name')" placeholder="Patient Name">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control form-control-inline date-picker" name="dob" id="dob" value="<?php if($row_patient_infos['dob']!=''){ echo date("d-m-Y", strtotime($row_patient_infos['dob'])); } ?>"  autocomplete="off">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="phone" onkeyup="value=value.replace(/[^\d]/g,'')" name="age"  id="age"  autocomplete="off" placeholder="Age in Years" class="form-control" value="<?php echo $row_patient_infos['age']; ?>" >
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="phone" onkeyup="value=value.replace(/[^\d]/g,'');mobile_check();" onblur="mobile_check();" name="phone_no"  id="phone_no"  autocomplete="off" placeholder="Enter 10 Digit ph no." class="form-control" value="<?php echo $row_patient_infos['phone_no']; ?>" >
                      <span id="error_mobie" style="color: red;font-weight:bold;"></span> </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
                      <label class="control-label">Email ID</label>
                      <input type="email" name="email_id"  id="email_id"  autocomplete="off" placeholder="Enter Email ID" class="form-control" value="<?php echo $row_patient_infos['email_id']; ?>" >
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select name="admiting_doctor" id="admiting_doctor" class="form-control select2"  >
                        ...
                        <?php 
							if($row3['users_id']==''){
								$selected_doc=$_REQUEST['doc_id_appt'];									
							}else{
								$selected_doc=$row3['users_id'];	
							}
								 ...
								 {									 
									 ...
									 echo '<option value="'.$row7['id'].'" '; if($selected_doc==$row7['id']) echo 'selected'; echo '>'.$row7['name'].'</option>';
                  ...
                  <p>&nbsp;</p>
                  <?php if(isset($_REQUEST['old_db_id'])){ ?>
                  <div class="col-md-12">
                        ...
                        <table class="table table-striped table-bordered table-advance table-hover" id="kyc_iop_tab" style="overflow-x: auto !important;">
                          ...
                          <tbody>
                            <?php				 	$sl=1;
													 ...
													 ?>
                          <input type="hidden" name="kyc_countiop" id="kyc_countiop" value="1">
                ...
                <p style="padding:12px 0 2px 0; text-align:center;backgroung:#fff">
                  ...
                  <?php }else{ ?>
                  <button type="button" name="submit_check" id="submit_check" class="btn green" onClick="uhid_generate()">Submit</button>
...
<?php if(isset($_REQUEST['old_db_id'])){ ?>
uhid_generate_old_db();
<?php }else{ ?>
//uhid_generate();
<?php } ?>

<?php if(isset($_REQUEST['register_by_pat_id'])){ ?>
reg_by_patient_fetch();
<?php }?>
...
function uhid_generate(){
	...
	$("#submit").prop( "disabled", true );
		...
		$.ajax({
							...
							url : "<?php echo ADMIN_URL; ?>ajax/uhid_generate_ajax.php",
							...
							success : function(data) {	
									...
									$("#uhid_no").val(data.mrd_no);
									
									var submit_fl=validation_check();
									if(submit_fl==0){
										$("#submit").prop( "disabled", false );
										$("#submit").click();	
									}
...
function uhid_generate_old_db(){
	//alert="ani";
	var old_db_id=$("#old_db_id").val();
	if(old_db_id==''){
		return false;	
	}
				...
				$.ajax({
								...
								url : "<?php echo ADMIN_URL; ?>ajax/old_db_ajax.php?flag=2",

								dataType : "json", 

								data : "old_db_id="+old_db_id,

								success : function(data) {					 

											$("#old_db_pref").html("(Old: "+data.old_prefix+")");	
...
function reg_by_patient_fetch(){
	//alert="ani";
	var register_by_pat_id=$("#register_by_pat_id").val();
	if(register_by_pat_id==''){
		return false;	
	}
				...
				$.ajax({
								...
								url : "<?php echo ADMIN_URL; ?>ajax/old_db_ajax.php?flag=5",

								dataType : "json", 

								data : "register_by_pat_id="+register_by_pat_id,
								...
								success : function(data) {					 
											...
											$("#admiting_doctor").val(data.admiting_doctor);
...
function phone_change(){
	var uhid_no = $("#uhid_no").val();
			...
			$.ajax({
							...
							url : "<?php echo ADMIN_URL; ?>ajax/old_db_ajax.php?flag=4",

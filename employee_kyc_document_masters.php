...
if(isset($_REQUEST['submit']))
{
	// New Data Add
	if($_REQUEST['id']!=''){	
	    $kyc_document_name=mysqli_real_escape_string($conn,$_REQUEST['kyc_document_name']);
		...
		$sql = "UPDATE `employee_kyc_document_masters` SET `kyc_document_name`='".$kyc_document_name."',`modified_by`='".$modified_by."',`modified_time`='".$modified_time."'  WHERE `id`='".$id."'";
		if($conn->query($sql)===TRUE)
		{
		$msg="Record updated successfully";
		$flg=0;
		$redirectUrl=ADMIN_URL.'employee_kyc_document_masters.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `employee_kyc_document_masters` SET `kyc_document_name`='".$kyc_document_name."',`created_by`='".$created_by."',`created_on`='".$created_on."' ";			
		if($conn->query($sql)===TRUE)
		{
		$flg=0;
...
if(isset($_REQUEST['delete']))
{
	...
	$sql = "UPDATE `employee_kyc_document_masters` SET `del_flag`='1',`deleted_by`='".$deleted_by."',`deleted_time`='".$deleted_time."' WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				 ...
				 //$today=date('Y-m-d');
				 $total_count=0;
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `employee_kyc_document_masters`";
				$result=$conn->query($sql) ;				
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Employee's KYC Document</span></div>
            ...
            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
              ...
              <tbody>
                <?php 
				  $sql3="SELECT `id`, `kyc_document_name`, `created_by`, `created_on`, `modified_by`, `modified_time`, `del_flag`, `deleted_by`, `deleted_time` FROM `employee_kyc_document_masters`  Where `del_flag`='0' ORDER BY `id` DESC";
                ...
                <tr >
                  <td><?php echo $id; ?></td>
                  <td><?php echo $row3['kyc_document_name']; ?></td>
                ...
                <div class="modal-content" style="width:900px !important;"> 
                  ...
                  <div class="modal-body">
                    <div class="portlet box blue-hoki">
                      <div class="portlet-title" >
                        <div class="caption"> <i class="fa fa-gift"></i>Add New Employee's KYC Document</div>
                      </div>
                        ...
                        <form action="" method="post" class="form-horizontal"  enctype="multipart/form-data">
                          <div class="form-body">
                            <div class="form-group">
                              <label class="col-md-6 control-label">KYC Document Name</label>
                              <div class="col-md-5">
                                <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                  <input type="text" name="kyc_document_name" id="kyc_document_name" class="form-control" placeholder="Enter text" autocomplete="off" required/>
...
try{
		...
		$.ajax({
						type : "POST",
						url : "<?php echo ADMIN_URL; ?>ajax/employee_kyc_document_ajax.php",
						dataType : "json", 
						data : "id="+id,
						success : function(data) {						
							...
							try{
								 ...
								 $('#draggable').modal('show'); 
								  $("#kyc_document_name").val(data.kyc_document_name);
								  $("#id").val(data.id);

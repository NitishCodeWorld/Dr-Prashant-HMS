...
if(isset($_REQUEST['submit'])){
	// New Data Add
	if($_REQUEST['id']!=''){	
		$name=mysqli_real_escape_string($conn,$_REQUEST['medication_individual']);
		//$g_name=mysqli_real_escape_string($conn,$_REQUEST['medication_g_name']);
		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);
		$sql = "UPDATE `medication_individual_masters_for_emr` SET `medication_individual`='".$name."' WHERE `id`='".$id."'";
		if($conn->query($sql)===TRUE)
		{
		$msg="Record updated successfully";
		$flg=0;
		$redirectUrl=ADMIN_URL.'medication_individual_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$name=mysqli_real_escape_string($conn,$_REQUEST['medication_individual']);
		//$g_name=mysqli_real_escape_string($conn,$_REQUEST['medication_g_name']);
		$sql = "INSERT INTO `medication_individual_masters_for_emr` SET `medication_individual`='".$name."'";
		if($conn->query($sql)===TRUE)
		{
		$flg=0;
...
if(isset($_REQUEST['delete'])){
	$sql = "DELETE FROM `medication_individual_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <!-- END PAGE HEAD --> 
   			 <?php 
				 $total_count=0;
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `medication_individual_masters_for_emr`";
				$result=$conn->query($sql) ;				
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Medication Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
                  <?php 
				  $sql3="SELECT * FROM `medication_individual_masters_for_emr` ORDER BY `id` DESC";
				  ...
				  ?>                 
                   <tr >
                    <td> <?php echo $id; ?></td>
                    <td> <?php echo $row3['medication_individual']; ?></td>                   
                      ...
                      <div class="modal-content"> 
                        ...
                        <div class="modal-body">
                          <div class="portlet box blue-hoki">
                            <div class="portlet-title" >
                              <div class="caption"> <i class="fa fa-gift"></i>Add New Medication</div>
                            </div>
                              ...
                              <form action="" method="post" class="form-horizontal">
                                <div class="form-body">
                                  <div class="form-group">
                                    <label class="col-md-4 control-label">Medication Name</label>
                                    <div class="col-md-7">
                                      <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                       
                                        <textarea name="medication_individual" id="medication_individual" class="form-control" placeholder="Enter text" required></textarea>
      ...
      $(document).ready( function() {       
		setTimeout('$("#alert_msg").hide()',3000);
			...
			$("#add_new").click(function(){
				var empty='';
				$("#medication_individual").val(empty);
				$("#id").val(empty);				
				});
      });
function check(id){
...
try{
		...
		$.ajax({
						type : "POST",
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/medication_ajax_for_emr.php",
						dataType : "json", 
						data : "id="+id,
						success : function(data) {						
							...
							try{
								 ...
								 $("#medication_individual").val(data.gp_name);
								 $("#id").val(data.id);								

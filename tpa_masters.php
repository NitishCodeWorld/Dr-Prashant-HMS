...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$sql = "UPDATE `tpa_masters` SET `name`='".$name."',`modified_by`='".$modified_by."' ,`modified_time`='".$modified_time."' ,`address`='".$address."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'tpa_masters.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `tpa_masters` SET `name`='".$name."',`created_by`='".$created_by."',`created_on`='".$created_on."' ,`address`='".$address."' ";	
...

{
	...
	//$sql = "DELETE FROM `tpa_masters` WHERE `id`='".$_REQUEST['delete']."'";

	$deleted_by=$_SESSION['id'];

	$deleted_time=date('Y-m-d H:i:s');

	$sql = "UPDATE `tpa_masters` SET `del_flag`='1',`deleted_by`='".$deleted_by."',`deleted_time`='".$deleted_time."' WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
    ...
    <div class="container-fluid"> 
      ...
      <div class="page-title">
        ...
        <ul class="page-breadcrumb breadcrumb">
          <li> <a href="<?php echo ADMIN_URL; ?>tpa_masters.php">Home</a><i class="fa fa-circle"></i> </li>
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `tpa_masters`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">TPA</span></div>
            ...
            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
              ...
              <tbody>
                <?php 
				  ...
				  $sql3="SELECT `id`, `name`,`created_by`, `created_on`, `modified_by`, `modified_time`, `del_flag`, `deleted_by`, `deleted_time`,`address` FROM `tpa_masters` WHERE  `del_flag`='0' ORDER BY `id` DESC";
                ...
                <div class="modal-content"> 
                  ...
                  <div class="modal-body">
                    <div class="portlet box blue-hoki">
                      <div class="portlet-title" >
                        <div class="caption"> <i class="fa fa-gift"></i>Add / Edit TPA</div>
                      </div>
                        ...
                        <form action="" method="post" class="form-horizontal">
                          <div class="form-body">
                            <div class="form-group">
                              <label class="col-md-4 control-label">TPA</label>
                              <div class="col-md-7">
...
function check(id){
	...
	$.ajax({
			...
			url : "<?php echo ADMIN_URL; ?>ajax/tpa_masters_ajax.php",

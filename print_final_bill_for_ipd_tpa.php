...
if($del_flag=='1'){
	...
	$cancled=" FINAL BILL ( Cancelled Bill )";
 ...
 <tr>
  ...
  <tr>
    <td colspan="3" style="border: 2px solid #333; padding:6px; text-align:center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td style="border-right: 1px solid #333; border-bottom: 1px solid #333; padding-left:4px"><strong>MR No./IPD No.</strong></td>
          <td style="padding-left:4px; border-bottom: 1px solid #333;"><?php echo $row3['hospital_number'];  ?></td>
        </tr>
        <tr>
          <td style="border-right: 1px solid #333; border-bottom: 1px solid #333;"><strong>Age/Sex </strong></td>
          <td style="border-bottom: 1px solid #333; padding-left:4px"><?php echo $row3['age'].' Yrs / '.$row_gen['gender']; ?></td>
        ...
        <tr>
          <td style="border-right: 1px solid #333; border-bottom: 1px solid #333;"><strong>Insurance Co.</strong></td>
          <td style="border-bottom: 1px solid #333; padding-left:4px"><?php echo $insurance_name;  ?></td>
          <td style="border-right: 1px solid #333; border-bottom: 1px solid #333; padding-left:4px"><strong>Claim No.</strong></td>
          <td style="padding-left:4px; border-bottom: 1px solid #333;"><?php echo $claim_no;  ?></td>
        </tr>
        ...
        <tr>
          ...
          <td style="padding-left:4px; border-bottom: 1px solid #333;"><?php if($row3['date_of_discharge']!=''){ echo date("d/M/Y", strtotime($row3['date_of_discharge'])); } ?></td>
        </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td style="border-right: 1px solid #333;"><strong>Free Reason</strong></td>

          <td colspan="3" style="padding-left:4px"><?php echo $row3['free_reason'];  ?></td>
  ...
  <tr>
    <td colspan="3" style="border: 2px solid #333; padding:0px; text-align:center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="52%" style="border-right: 1px solid #333; border-bottom: 1px solid #333; text-align:left; padding-right:9px"><strong>Service Name</strong></td>
          <td width="16%" style="padding-left:4px; border-bottom: 1px solid #333; text-align:right;border-right: 1px solid #333;"><strong>Total Amount</strong></td>
          <td width="16%" style="padding-left:4px; border-bottom: 1px solid #333; text-align:right;border-right: 1px solid #333;"><strong>Disc. Amount</strong></td>
          <td width="16%" style="padding-left:4px; border-bottom: 1px solid #333; text-align:right;"><strong>Net Amount</strong></td>
        </tr>
        <?php		
  ...
  if($total_dicount>0){
	  ...
	  $default_rowspan=$default_rowspan+2;
  ...
  <tr>
    <td colspan="3" style="padding:0px; text-align:center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td rowspan="<?php echo $default_rowspan; ?>" style="text-align:left; vertical-align:bottom;text-transform:uppercase;font-size:13px;"><strong>Credit Bill towards <?php echo $payor_name;  ?> : Rupees
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="2" style="text-align:left; padding-right:9px;">This is Computerized Receipt/Bill, hence no signature required.</td>
  </tr>
</table>
<script>

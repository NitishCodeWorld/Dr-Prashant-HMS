...

{
	...
	if($_REQUEST['id']!=''){		
		...
		$sql = "UPDATE `area_masters_for_emr` SET `location`='".$location."',`pin`='".$pin."',`latitude`='".$latitude."',`longitude`='".$longitude."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'area_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `area_masters_for_emr` SET `location`='".$location."',`pin`='".$pin."',`latitude`='".$latitude."',`longitude`='".$longitude."'";
...

{
	...
	$sql = "DELETE FROM `area_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `area_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Area Master Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`,`location`, `pin`, `latitude`, `longitude` FROM `area_masters_for_emr` ORDER BY `id` DESC";
                    ...
                    <div class="modal-body">
                      ...
                      <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-title" >
                          ...
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Area with Pincode</div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-7">
                                  ...
                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                    ...
                                    <textarea name="location" id="location" class="form-control" placeholder="Enter text" required></textarea>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-7">
                                  ...
                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                    ...
                                    <input type="text" name="pin" id="pin" class="form-control" placeholder="Enter text" onBlur="get_lat_long()" required />
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-7">
                                  ...
                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                    ...
                                    <input type="text" name="latitude" id="latitude" class="form-control" placeholder="Enter text"  />
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-7">
                                  ...
                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                    ...
                                    <input type="text" name="longitude" id="longitude" class="form-control" placeholder="Enter text"  />
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/area_pin_ajax_for_emr.php",
...
<script>
	...
	function get_lat_long(){
		...
		$.ajax({
						...
						url : "https://maps.googleapis.com/maps/api/geocode/json?address="+zip+"&sensor=false&key=AIzaSyB8AMPMEDWceX2ANhuXpH0_gPH6HND5WGM",

						dataType: 'json',

						//data : "name=pf_remarks&pk=" + $("#pk_val").val()+"&value="+t.val(),

						success : function(data) {

							$.each(data.results, function(index, element) {

								$("#latitude").val(element.geometry.location.lat);

								$("#longitude").val(element.geometry.location.lng);								

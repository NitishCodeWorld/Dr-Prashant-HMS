...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$chief_complaints=mysqli_real_escape_string($conn,$_REQUEST['chief_complaints']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `chief_complaints_masters_for_emr` SET `chief_complaints`='".$chief_complaints."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'chief_complaints_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `chief_complaints_masters_for_emr`(`chief_complaints`) VALUES ('".$chief_complaints."')";
...

{
	...
	$sql = "DELETE FROM `chief_complaints_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `chief_complaints_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Chief Complaints Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `chief_complaints` FROM `chief_complaints_masters_for_emr` ORDER BY `id` DESC";
...

				 {
                  ...
                  <tr >
                    ...
                    <td><?php echo $row3['chief_complaints']; ?></td>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label"> Chief Complaints Name</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <textarea name="chief_complaints" id="chief_complaints" class="form-control" placeholder="Enter text" required></textarea>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/chief_complaints_ajax_for_emr.php",
						...
						success : function(data) {						
							...
							try{
								 ...
								 $("#chief_complaints").val(data.chief_complaints);

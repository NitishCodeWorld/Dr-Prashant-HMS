                    ...
                    <div class="row" style="background:#dcefff;!important; padding:9px 0px">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <select class=" form-control select2" name="vendor_id" id="vendor_id" onChange="get_purchase_amt()" required>
                            ...
                            <?php 
								  $sql7="SELECT * FROM `vendor_master` WHERE `status`='1' ORDER BY `vendor_name` ASC ";
								 ...
								 {									 
									 ...
									 echo '<option value="'.$row7['id'].'" ';  echo '>'.$row7['vendor_name'].'</option>';
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                         ...
                         <input type="phone" onkeyup="value=value.replace(/[^\d]/g,'');get_purchase_amt();" name="opening_bal"  id="opening_bal"  autocomplete="off" placeholder="Enter Amount" class="form-control" value="0"  >
                        </div>
                      </div>                    
                      <div class="col-md-3">
                        <div class="form-group">

...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$certificate_masters_name=mysqli_real_escape_string($conn,$_REQUEST['certificate_masters_name']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `certificate_masters_for_emr` SET `certificate_masters_name`='".$certificate_masters_name."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'certificate_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `certificate_masters_for_emr`(`certificate_masters_name`) VALUES ('".$certificate_masters_name."')";
...

{
	...
	$sql = "DELETE FROM `certificate_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
	...
	header("location:".ADMIN_URL."certificate_masters_for_emr.php?msg=".$msg."&flg=".$flg);
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `certificate_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Certificate Master Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `certificate_masters_name` FROM `certificate_masters_for_emr` ORDER BY `id` DESC";
...

				 {
                  ...
                  <tr >
                    ...
                    <td><?php echo $row3['certificate_masters_name']; ?></td>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-title" >
                          ...
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Certificate Master</div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label">Certificate Master Name</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <textarea name="certificate_masters_name" id="certificate_masters_name" class="form-control" placeholder="Enter text" required></textarea>
      ...
      $(document).ready( function() {       
		...
		setTimeout('$("#alert_msg").hide()',3000);
			...
			$("#add_new").click(function(){
				...
				$("#certificate_masters_name").val(empty);
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/certificate_master_ajax_for_emr.php",
						...
						success : function(data) {						
							...
							try{
								 ...
								 $("#certificate_masters_name").val(data.certificate_masters_name);

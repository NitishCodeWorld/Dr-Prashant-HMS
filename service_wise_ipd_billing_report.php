      ...
      <div class="col-md-12"> 
        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase" id="title_span"> IPD Service Wise Billing Details </span></div>
...
function date_wise_db(){
	...
	var print_url="<?php echo ADMIN_URL.'service_wise_ipd_billing_fecth.php?from_date=';  ?>"+from_date+"<?php echo '&to_date=';  ?>"+to_date;

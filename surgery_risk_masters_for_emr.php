...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$surgery_risk=mysqli_real_escape_string($conn,$_REQUEST['surgery_risk']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `surgery_risk_masters_for_emr` SET `surgery_risk`='".$surgery_risk."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'surgery_risk_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `surgery_risk_masters_for_emr`(`surgery_risk`) VALUES ('".$surgery_risk."')";
...

{
	...
	$sql = "DELETE FROM `surgery_risk_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `surgery_risk_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Surgery Risk Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `surgery_risk` FROM `surgery_risk_masters_for_emr` ORDER BY `id` DESC";
...

				 {
                  ...
                  <tr >
                    ...
                    <td><?php echo $row3['surgery_risk']; ?></td>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-title" >
                          ...
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Surgery Risk</div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                ...
                                <label class="col-md-4 control-label">Surgery Risk Name</label>

                                <div class="col-md-7">

                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                    <textarea name="surgery_risk" id="surgery_risk" class="form-control" placeholder="Enter text" required></textarea>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/surgery_risk_ajax_for_emr.php",
						...
						success : function(data) {						
							...
							try{
								 ...
								 $("#surgery_risk").val(data.surgery_risk);

...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="3" style="border: 1px solid #333; padding:6px; text-align:center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="15%" style="border-right: 1px solid #333; border-bottom: 1px solid #333;"><strong>Bill No.</strong></td>
          <td width="35%" style="border-bottom: 1px solid #333; padding-left:4px"><?php echo $row_hospital_info['hos_short_code'].'/'.$m_f_year.'/'.$bill_for.'/'.$row3['invo_no'];  ?></td>
        ...
        <tr>
          ...
          <td style="padding-left:4px; border-bottom: 1px solid #333;"><?php 
            ...
            <?php		
						...
						$sql2_additional_doc="SELECT `user_infos`.`name` FROM `additional_doctor_for_invoice_final_billing` INNER JOIN `user_infos` ON `additional_doctor_for_invoice_final_billing`.`additional_doctor_id` =`user_infos`.`users_id` WHERE `additional_doctor_for_invoice_final_billing`.`i_id`= '" .$id. "' AND `additional_doctor_for_invoice_final_billing`.`patient_registration_id`= '" .$row3['patient_registration_id']. "' AND `additional_doctor_for_invoice_final_billing`.`hospital_number`= '" .$row3['hospital_number']. "'  AND `additional_doctor_for_invoice_final_billing`.`del_flag`='0' ";
        ...
        <tr>
          <td style="border-right: 1px solid #333; border-bottom: 1px solid #333;"><strong>Payer Name</strong></td>
        ...
        <?php if(($row3['free_reason']!='')||($row3['ref_doctor_id']!='')){ ?>
        <tr>
          ...
          <?php } ?>
          <?php if($row3['free_reason']!=''){ ?>
          <td style="border-right: 1px solid #333; border-bottom: 1px solid #333;"><strong>Disc Reason</strong></td>
          <td  style="padding-left:4px; border-bottom: 1px solid #333;"><?php echo $row3['free_reason'];  ?></td>
          <?php }else{ ?>
          <td style="border-right: 1px solid #333; border-bottom: 1px solid #333; padding-left:4px"></td>
          <td style="padding-left:4px; border-bottom: 1px solid #333;"></td>
          <?php } ?>
  ...
  <tr>
    <td colspan="3" style="border: 1px solid #333; padding:0px; text-align:center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="8%" style="border-bottom: 1px solid #333; border-right: 1px solid #333; text-align:center;"><strong>Sl. No.</strong></td>
          <td width="53%" style="border-right: 1px solid #333; border-bottom: 1px solid #333; text-align:left; padding-right:9px"><strong>Service Name</strong></td>
          <td width="13%" style="padding-left:4px; border-bottom: 1px solid #333; text-align:right;border-right: 1px solid #333;"><strong>Total Amount</strong></td>
          <td width="13%" style="padding-left:4px; border-bottom: 1px solid #333; text-align:right;border-right: 1px solid #333;"><strong>Disc. Amount</strong></td>
          <td width="13%" style="padding-left:4px; border-bottom: 1px solid #333; text-align:right;"><strong>Net Amount</strong></td>
        </tr>
        <?php		
			...
			$sql2_lab_proc="SELECT * FROM `invoice_final_procedure` WHERE `i_id`= '" .$id. "' AND `patient_registration_id`= '" .$row3['patient_registration_id']. "' AND `hospital_number`= '" .$row3['hospital_number']. "'  AND `del_flag`='0' ";
  ...
  <tr>
    <td colspan="3" style="padding:0px; text-align:center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td  style="text-align:left; vertical-align:top"><p><strong>Net Amount in words:</strong> Rupees <?php echo ucwords(number_to_indian_rupees_convert($row3['total']));?> only</p>
...
if($result_payment_details->num_rows > 0){
	...
	echo $first_char=$var_arr[0]; }else{ echo $row3['invo_no'];}  ?></td>
		...
		?>
          ...
          <td  colspan="2" style="text-align:left; vertical-align:top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-right: 1px solid #333; border-top: 1px solid #333; border-left: 1px solid #333; padding-right:4px; text-align:left;"><strong>Total Amount </strong></td>
                <td style="padding-left:4px; border-top: 1px solid #333; border-right: 1px solid #333; text-align:right;"><?php echo number_format(($procedure_amount_tot),2);  ?></td>
              </tr>
              <tr>
                <td style="border-right: 1px solid #333; border-top: 1px solid #333; border-left: 1px solid #333; padding-right:4px; text-align:left;"><strong>Discount <?php echo $discount_reason; ?></strong></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td style="padding-left:5px;"><strong>Prepared by</strong></td>
    <td style="text-align:right; padding-right:9px;font-size: 10pt;"><strong>For: <?php echo $row_hospital_info['hospital_name'];  ?></strong></td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>

...
if(isset($_POST['submit'])){
  ...
  $query_contact_number = mysqli_real_escape_string($conn,$_POST['query_contact_number']);
	...
	$discharge_date='NULL';
		...
		$discharge_date= "'".date("Y-m-d", strtotime($_REQUEST['discharge_date']))."'";
	}
	//echo $discharge_date;
	...
	$modified_on=date('Y-m-d H:i:s');
	  $sql="UPDATE patient_discharge_summary set `prefix`='".$prefix."', `patient_name`='".$patient_name."', `dob`=".$dob.", `age`='".$age."', `gender`='".$gender."', `registration_date`=".$registration_date.", `registration_time`=".$registration_time.", `discharge_date`=".$discharge_date.", `phone_no`='".$phone_no."', `procedure`='".$procedure."', `procedure_eye`='".$procedure_eye."', `procedure_type`='".$procedure_type."', `anaesthesia_date`=".$anaesthesia_date.", `admiting_doctor`='".$admiting_doctor."', `anaesthetst_doctor`='".$anaesthetst_doctor."', `medication_editor`='".$medication_editor."', `next_postop_chkup`=".$next_postop_chkup.", `next_postop_chkup_time`=".$next_postop_chkup_time.", `final_postop_chkup`=".$final_postop_chkup.", `query_contact_number`='".$query_contact_number."', `modified_by`='".$modified_by."', `modified_on`='".$modified_on."', `discharge_time`=".$discharge_time." where id='".$discharge_id."'";
        ...
        <div class="col-md-12">
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-blue-sharp"></i> <span class="caption-subject font-blue-sharp bold uppercase">discharge summary form edit</span></div>
            </div>
            <form  action="" method="post" enctype="multipart/form-data" class="horizontal-form">
            <input type="hidden" name="discharge_id" id="discharge_id" value="<?php echo $row3['id'];?>" />
              <div class="form-body">
                <div class="row" style="background:#dcefff;!important; padding:9px 0px">
                  <div class="col-md-1">
                    <div class="form-group">
                      <div class="input-group">
                        <input type="hidden" name="uhid_no_param" id="uhid_no_param" class="form-control"  placeholder="Name" value="<?php if(isset($row3['uhid_no'])){ echo $row3['uhid_no']; }?>" >
                      </div>
                    </div>
                  </div>
                ...
                <div class="row" style="background:#dcefff; padding:9px 0px">
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="text" id="uhid_no"  name="uhid_no" class="form-control" placeholder="UHID No." value="<?php if(isset($row3['uhid_no'])){ echo $row3['uhid_no']; }?>" readonly>
                      ...
                      <select class="form-control" name="prefix" id="prefix" onchange="gender_defualt();">
                        <?php 
								 ...
								 while($row7=mysqli_fetch_array($result7,MYSQLI_ASSOC)){									 
									 echo '<option value="'.$row7['id'].'"';if($row7['id']==$row3['prefix']){echo 'selected';};  echo '>'.$row7['prefix_name'].'</option>';
								 }
					 			?>
                      </select>
                    </div>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" id="patient_name" value="<?php echo $row3['patient_name'];?>" name="patient_name" class="form-control" placeholder="Patient Name">
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control form-control-inline date-picker" name="dob" id="dob" value="<?php if($row3['dob']!=''){echo date('d-m-Y',strtotime($row3['dob']));}else{echo '';};?>"  autocomplete="off" >
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="gender" id="gender">
                        ...
                        <?php 
								 ...
								 $result7=$conn->query($sql7) ;
								 while($row7=mysqli_fetch_array($result7,MYSQLI_ASSOC)){									 
									 echo '<option value="'.$row7['id'].'" ';if($row7['id']==$row3['gender']){echo 'selected';};  echo '>'.$row7['gender'].'</option>';
								 }
					 			?>
                      </select>
                    </div>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-inline date-picker" placeholder="Select Admitting Date" id="registration_date" name="registration_date" value="<?php if($row3['registration_date']!=''){echo date('d-m-Y',strtotime($row3['registration_date']));}else{echo '';};?>" />
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label class="control-label">Admission Time (h:m A)</label>
                      <input type="text" class="form-control form-control-inline date-picker" placeholder="Select Admitting Date" id="registration_time" name="registration_time" value="<?php if($row3['registration_time']!=''){echo date('h:i A',strtotime($row3['registration_time']));}else{echo '';};?>" />
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          <input type="text" class="form-control form-control-inline date-picker" placeholder="Select Discharge Date" id="discharge_date" name="discharge_date" value="<?php if($row3['discharge_date']!=''){echo date('d-m-Y',strtotime($row3['discharge_date']));}else{echo '';};?>">
                          <span class="input-group-addon" style="padding:0 !important; width:50% !important">
                          <input type="text" class="form-control form-control-inline time-picker" placeholder="Select Discharge Time" name="discharge_time" id="discharge_time" value="<?php if($row3['discharge_time']!=''){echo date('h:i A',strtotime($row3['discharge_time']));}else{echo '';};?>">
                          </span></div>
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="phone" onkeyup="value=value.replace(/[^\d]/g,'')" name="phone_no"  id="phone_no"  autocomplete="off" placeholder="Enter 10 Digit ph no." class="form-control" value="<?php echo $row3['phone_no']; ?>" >
                    </div>
                  </div>
                  ...
                  <div class="col-md-12"> <span style="display:flex;justify-content: space-between;">
                    ...
                    <div class="col-md-12">
                      <table class="table table-bordered table-advance table-hover" id="tab_medication">
                        ...
                        <tbody id="diagnoses_tbody">
                          <?php 
								  $sl=1;
								  $sql2="SELECT * FROM `patient_discharge_diagnoses_details_table` WHERE `patient_discharge_id`= '" .$patient_discharge_id. "' and `del_flag`<>1";
                          ...
                          <tr id="diagnoses<?php echo $sl_med;?>">
                            ...
                            <td><div class="input-group">
                                <select class="form-control" name="discharge_diagnoses_eye<?php echo $sl_med;?>" id="discharge_diagnoses_eye<?php echo $sl_med;?>">
                                  ...
                                  <option value="BOTH EYES" <?php if($row2['discharge_diagnoses_eye']=='BOTH EYES') echo 'selected'; ?>>BOTH EYES</option>
                                </select>
                              </div></td>
                    ...
                    <div class="col-md-12">
                      <div class="input-group"> <span class="input-group-addon">Procedure</span>
                        <!--<input type="text" name="procedure" id="procedure" class="form-control" value="<?php echo $row3['procedure'];?>" placeholder="Enter Procedure"/>-->
                        <textarea name="procedure" id="procedure" class="form-control" value="" placeholder="Enter Procedure"><?php echo $row3['procedure'];?></textarea>
                        <span class="input-group-addon">In the</span>
                        <input type="text" name="procedure_eye" id="procedure_eye" class="form-control" value="<?php echo $row3['procedure_eye'];?>" placeholder="Enter Eye"/>
                        <span class="input-group-addon"> under</span>
                        <input type="text" name="procedure_type" id="procedure_type" class="form-control" value="<?php echo $row3['procedure_type'];?>" placeholder="Enter Type"/>
                        <span class="input-group-addon">anaesthesia on</span>
                        <input type="text" name="anaesthesia_date" id="anaesthesia_date" class="form-control form-control-inline date-picker" value="<?php if($row3['anaesthesia_date']!=''){echo date('d-m-Y',strtotime($row3['anaesthesia_date']));}else{echo '';};?>" placeholder="Enter Date"/>
                      </div>
                    </div>
                    <div class="col-md-12" style="margin-top:10px;">
                        ...
                        <div class="form-group">
                          ...
                          <select name="admiting_doctor" id="admiting_doctor" class="form-control select2" >
                            ...
                            <?php 
								 ...
								 $result7=$conn->query($sql7) ;
								 while($row7=mysqli_fetch_array($result7,MYSQLI_ASSOC)){
									 echo '<option value="'.$row7['id'].'" ';if($row7['id']==$row3['admiting_doctor']){echo 'selected';};  echo '>'.$row7['name'].'</option>';
								 }
					 			?>
                          </select>
                        </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="control-label">Anaesthetst</label>
                          <input type="text" name="anaesthetst_doctor" id="anaesthetst_doctor" class="form-control" value="<?php echo $row3['anaesthetst_doctor'];?>" placeholder="Enter Anaesthetist" />
                        </div>
                      </div>
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          <table class="table table-bordered table-advance table-hover" id="tab_anaesthetst">
                            ...
                            <tbody id="anaesthetst_tbody">
                              <?php 
								  $sl=1;
								  $sql2="SELECT * FROM `patient_discharge_anaesthetst_assistent_details` WHERE `patient_discharge_id`= '" .$patient_discharge_id. "' and `del_flag`<>1";
								  $result2=$conn->query($sql2) ;
								  $count=$result2->num_rows;
								  if($count=='0'){
                    ...
                    <div class="col-md-12">
                      ...
                      <textarea id="medication_editor" name="medication_editor" class="form-control ckeditor" placeholder="Enter text"><?php echo $row3['medication_editor'];?></textarea>
                    </div>
                    <div class="col-md-12"  style="margin-top:12px;">
                      <p><strong>FOLLOW UP</strong></p>
                      <div class="input-group"> <span class="input-group-addon">Next post-op check-up:</span>
                        <input type="text" name="next_postop_chkup" id="next_postop_chkup" class="form-control" value="<?php if($row3['next_postop_chkup']!=''){echo date('d-m-Y',strtotime($row3['next_postop_chkup']));}else{echo '';};?>" placeholder="Enter Date"/>
                        <span class="input-group-addon">at</span>
                        <input type="text" name="next_postop_chkup_time" id="next_postop_chkup_time" class="form-control" value="<?php if($row3['next_postop_chkup_time']!=''){echo date('h:i A',strtotime($row3['next_postop_chkup_time']));}else{echo '';};?>" placeholder="Enter Time"/>
                        <span class="input-group-addon">Final post-op check-up:</span>
                        <input type="text" name="final_postop_chkup" id="final_postop_chkup" class="form-control" value="<?php if($row3['final_postop_chkup']!=''){echo date('d-m-Y',strtotime($row3['final_postop_chkup']));}else{echo '';};?>" placeholder="Enter Date"/>
                        <span class="input-group-addon">Contact No:</span>
                        <input type="text" name="query_contact_number" id="query_contact_number" class="form-control" value="<?php echo $row3['query_contact_number'];?>" placeholder="Enter Contact No."/>
                      </div>
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <table class="table table-bordered table-advance table-hover" id="tab_post_up_chkup">
                            ...
                            <tbody id="post_up_chkup_tbody">
                              <?php 
								  $sl=1;
								  $sql2="SELECT * FROM `patient_discharge_post_up_chkup_details` WHERE `patient_discharge_id`= '" .$patient_discharge_id. "' and `del_flag`<>1";
								  $result2=$conn->query($sql2) ;
								  $count=$result2->num_rows;
								  if($count=='0'){
                              ...
                              <tr id="post_up_chkup<?php echo $sl_med;?>">
                                <td><?php echo $sl_med;?></td>
                                <td><textarea name="post_up_chk_up_advice<?php echo $sl_med;?>" id="post_up_chk_up_advice<?php echo $sl_med?>" class="form-control"><?php echo $row2['post_up_chk_up_advice'];?></textarea></td>

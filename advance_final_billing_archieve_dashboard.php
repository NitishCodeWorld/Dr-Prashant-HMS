      ...
      <div class="col-md-12"> 
        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Advance Billing Dashbaoard</span></div>
            ...
            <div class="table-toolbar">
              <div class="table-toolbar">
                <div class="col-md-12 col-sm-12 col-xs-12" style="border:none !important">
                  ...
                  <div class="col-md-3"> <span class="bill_gene"> BILL GENERATION </span> </div>
                  <div class="col-md-12">
                    <p><br/>
                    </p>
                  </div>
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <span class="bill_search"> BILL SEARCH </span> </div>
              </div>
              <div class="col-md-12">
                <p>&nbsp;</p>
              </div>
...
function old_pt_search_db(fl){
	...
	$.ajax({
				...
				data : "type="+type+"&srch="+srch+"&page_name=advance",
...
if(tab_asset_entry!="") tab_asset_entry.destroy();
	...
	$.ajax({
            ...
            url: 'get_json_data_for_ipd_details.php?flag=6',

...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$sql = "UPDATE `procedure_details_master_for_emr` SET `procedure_name`='".$procedure_name."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'procedure_details_master_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `procedure_details_master_for_emr`(`procedure_name`) VALUES ('".$procedure_name."')";
...

{
	...
	$sql = "DELETE FROM `procedure_details_master_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
	...
	header("location:".ADMIN_URL."procedure_details_master_for_emr.php?msg=".$msg."&flg=".$flg);
...
<div class="page-container"> 
  ...
  <!-- END PAGE HEAD --> 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `procedure_details_master_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Procedure Details Master Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `procedure_name` FROM `procedure_details_master_for_emr` ORDER BY `id` DESC";
                        ...
                        <div class="modal-body">
                          ...
                          <div class="portlet box blue-hoki">
                            ...
                            <div class="portlet-title" >
                              ...
                              <div class="caption"> <i class="fa fa-gift"></i>Add New Procedure Details Master</div>
                              ...
                              <form action="" method="post" class="form-horizontal">
                                ...
                                <div class="form-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <label class="col-md-4 control-label">Procedure Details Master Name</label>

                                    <div class="col-md-7">

                                      <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>

                                      <textarea name="procedure_name" id="procedure_name" class="form-control" placeholder="Enter text" required></textarea>
...
try{
		...
		$.ajax({
						...
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/procedure_details_master_ajax_for_emr.php",

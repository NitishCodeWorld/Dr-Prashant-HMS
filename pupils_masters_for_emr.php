...
if(isset($_REQUEST['submit']))
{
	...
	if($_REQUEST['id']!=''){	
		...
		$sql = "UPDATE `pupils_masters_for_emr` SET `pupils`='".$pupils."' WHERE `id`='".$id."'";
		if($conn->query($sql)===TRUE)
		{
		$msg="Record updated successfully";
		$flg=0;
		$redirectUrl=ADMIN_URL.'pupils_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$pupils=mysqli_real_escape_string($conn,$_REQUEST['pupils']);
		$sql = "INSERT INTO `pupils_masters_for_emr`(`pupils`) VALUES ('".$pupils."')";
		if($conn->query($sql)===TRUE)
		{
		$flg=0;
...
{
	$sql = "DELETE FROM `pupils_masters_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				 ...
				 //$today=date('Y-m-d');
				 $total_count=0;
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `pupils_masters_for_emr`";
				$result=$conn->query($sql) ;				
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Pupils Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
                  <?php 
				  $sql3="SELECT `id`, `pupils` FROM `pupils_masters_for_emr` ORDER BY `id` ASC";
                  ...
                  <div class="modal-content"> 
                    ...
                    <div class="modal-body">
                      <div class="portlet box blue-hoki">
                        <div class="portlet-title" >
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Pupil</div>
                        </div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            <div class="form-body">
                              <div class="form-group">
                                <label class="col-md-4 control-label">Pupil Name</label>
                                <div class="col-md-7">
                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                    <textarea name="pupils" id="pupils" class="form-control" placeholder="Enter text" required></textarea>
...
try{
		...
		$.ajax({
						type : "POST",
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/pupils_ajax_for_emr.php",
						dataType : "json", 
						data : "id="+id,

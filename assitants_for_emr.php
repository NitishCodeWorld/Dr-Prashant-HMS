...
if(isset($_REQUEST['submit']))
{
	// New Data Add
	if($_REQUEST['id']!=''){	
		$assitant_name=mysqli_real_escape_string($conn,$_REQUEST['assitant_name']);
		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);
		$sql = "UPDATE `assitants_for_emr` SET `assitant_name`='".$assitant_name."' WHERE `id`='".$id."'";
		if($conn->query($sql)===TRUE)
		{
		$msg="Record updated successfully";
		$flg=0;
		$redirectUrl=ADMIN_URL.'assitants_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$assitant_name=mysqli_real_escape_string($conn,$_REQUEST['assitant_name']);
		$sql = "INSERT INTO `assitants_for_emr`(`assitant_name`) VALUES ('".$assitant_name."')";
		if($conn->query($sql)===TRUE)
		{
		$flg=0;
...
{
	$sql = "DELETE FROM `assitants_for_emr` WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				 ...
				 //$today=date('Y-m-d');
				 $total_count=0;
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `assitants_for_emr`";
				$result=$conn->query($sql) ;				
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Assitant Master</span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
                  <?php 
				  $sql3="SELECT `id`, `assitant_name` FROM `assitants_for_emr` ORDER BY `id` DESC";
				 ...
				 while ($row3=mysqli_fetch_array($result3,MYSQLI_ASSOC))
				 {
                  ...
                  <tr >
                    <td><?php echo $id; ?></td>
                    <td><?php echo $row3['assitant_name']; ?></td>
                  ...
                  <div class="modal-content"> 
                    ...
                    <div class="modal-body">
                      <div class="portlet box blue-hoki">
                        <div class="portlet-title" >
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Assitant</div>
                        </div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            <div class="form-body">
                              <div class="form-group">
                                <label class="col-md-4 control-label">Assitant Name</label>
                                <div class="col-md-7">
                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                    <input type="text" name="assitant_name" id="assitant_name" class="form-control" placeholder="Enter text" required/>
...
try{
		...
		$.ajax({
						type : "POST",
						url : "<?php echo ADMIN_URL; ?>ajax_for_emr/assitant_ajax_for_emr.php",
						dataType : "json", 
						data : "id="+id,
						success : function(data) {						
							...
							try{
								 ...
								 $("#assitant_name").val(data.assitant_name);
								 $("#id").val(data.id);								

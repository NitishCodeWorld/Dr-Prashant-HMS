...
<head>
<meta charset="utf-8"/>
<title>Sale Order Vender Invoice</title>
                ...
                <th colspan="4" scope="row"> <table class="table table-striped table-bordered table-hover" width="100%" id="main_body">
                    <thead>
                      <tr style="text-align:center">
                        ...
                        <td>HSN Code</td>
                        <td>Batch No</td>
                        <td>ExpDt</td><td>Size</td><td>Color</td>
                        <td>Qty</td>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><?php echo $row_['size']; ?></td><td class="text-center"><?php echo $row_['color']; ?></td>

...

{
	...
	if($_REQUEST['id']!=''){	
		...
		$purpose_visit=mysqli_real_escape_string($conn,$_REQUEST['purpose_visit']);

		$id=mysqli_real_escape_string($conn,$_REQUEST['id']);

		$sql = "UPDATE `purposevisit_masters_for_emr` SET `purpose_visit`='".$purpose_visit."' WHERE `id`='".$id."'";
		...
		$redirectUrl=ADMIN_URL.'purposevisit_masters_for_emr.php?msg='.$msg.'&flg='.$flg;
	...
	//Edit Data
		...
		$sql = "INSERT INTO `purposevisit_masters_for_emr`(`purpose_visit`) VALUES ('".$purpose_visit."')";
...

{
	...
	$sql = "UPDATE `purposevisit_masters_for_emr` SET  `del_flag`='1', `deleted_by`='".$created_by."', `deleted_time`='".$today."'  WHERE `id`='".$_REQUEST['delete']."'";
...
<div class="page-container"> 
  ...
  <?php 
				...
				$sql="SELECT COUNT(DISTINCT `id`) AS `total_count` FROM `purposevisit_masters_for_emr`";
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet light">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Purpose Of Visit Details </span></div>
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                ...
                <tbody>
				  ...
				  $sql3="SELECT `id`, `purpose_visit` FROM `purposevisit_masters_for_emr` WHERE `del_flag`='0' ORDER BY `id` DESC";
...

				 {
                  ...
                  <tr >
                    <td><?php echo $id; ?></td>
                    <td><?php echo $row3['purpose_visit']; ?></td>
                  ...
                  <div class="modal-content"> 
                    ...
                    <div class="modal-body">
                      <div class="portlet box blue-hoki">
                        <div class="portlet-title" >
                          <div class="caption"> <i class="fa fa-gift"></i>Add New Purpose Of Visit</div>
                        </div>
                          ...
                          <form action="" method="post" class="form-horizontal">
                            <div class="form-body">
                              <div class="form-group">
                                <label class="col-md-4 control-label">Purpose Of Visit Name</label>
                                <div class="col-md-7">
                                  <div class="input-group"><span class="input-group-addon"> <i class="fa fa-stethoscope"></i> </span>
                                    <input type="text" name="purpose_visit" id="purpose_visit" class="form-control" placeholder="Enter text" required/>
...
function check(id){
		$.ajax({
			type : "POST",
			url : "<?php echo ADMIN_URL; ?>ajax_for_emr/purposevisit_masters_ajax_for_emr.php",
			dataType : "json", 
			data : "id="+id,
			success : function(data) {
					 $('#draggable').modal('show'); 	
					 $("#purpose_visit").val(data.purpose_visit);
					 $("#id").val(data.id);							
			}

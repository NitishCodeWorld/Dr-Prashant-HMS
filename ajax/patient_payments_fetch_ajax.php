...
//Payment 1
$sql="SELECT * FROM `adavnce_final_billing` WHERE `patient_registration_id`= '" .$patient_registration_id. "' AND `del_flag`='0' AND `opd_flag`= '" .$opd_flag. "' AND `adjust_with_final_bill_flag`='0' ";
...
$expneses_abouts="<a href='".ADMIN_URL."print_advance_final_bill.php?id=".$id."' target='_blank' >Advance Bill No: '".$lab_bill_invo."' </a> <br/>Bill date: '".$lab_bill_date;
$expence_title="Advance Bill";

      ...
      <div class="col-md-12"> 
        ...
        <div class="portlet light">
          <div class="portlet-title">
            <div class="caption"> <i class="fa fa-cogs font-green-sharp"></i> <span class="caption-subject font-green-sharp bold uppercase">Refund Advance Billing Dashbaoard</span></div>
...
function purpose(id){
	...
	if (purpose != null && purpose != '') {
		...
		location.href = '<?php echo ADMIN_URL; ?>action/invoice_hospital_bill_action.php?id='+id+'&a=delAdvanceBillRefund&reason='+purpose;
...
if(tab_asset_entry!="") tab_asset_entry.destroy();
	...
	$.ajax({
            ...
            url: 'get_json_data_for_ipd_details.php?flag=9',
